...
<a href="https://www.tripo3d.ai/de/3d-prompts/bubble-bay"><img src="../assets/previews/3f9d3b8fcab4a54ff4bf19c6f25eb3f3ce6ce697cb929ab0abf86e89d6b8f708.jpg" width="840" loading="lazy" alt="Bubble Bay: 3D-Wasserballon-Schlacht"></a>

<a href="https://www.tripo3d.ai/de/3d-prompts/bubble-bay"><img src="../assets/previews/a0927800e707bb993467cd9c9d32d7955cafcad0fe1ab3986c33d6bec6ce85f8.jpg" width="840" loading="lazy" alt="Bubble Bay: 3D-Wasserballon-Schlacht"></a>

<a href="https://www.tripo3d.ai/de/3d-prompts/bubble-bay"><img src="../assets/previews/44f0d05c544d89c5044aece0e9da8cc3730bc51d81f395ff0e554bbceb4f2ab2.jpg" width="840" loading="lazy" alt="Bubble Bay: 3D-Wasserballon-Schlacht"></a>

Erstelle eine klassische 3D-Wasserbombenschlacht auf Pirate14 und Village10 mit drei animierten P2-Charakteren, naher Perspektive, schillernden Fallenblasen, konfigurierbaren Fangzielen, KI-Rivalen, eigenen Charakterimporten und eigener ElevenLabs-Musik. Standardmäßig sind sechs Fänge eingestellt; die Vergleichs-Tabs werden erst nach dem Laden angezeigt.

**Prompt**

```text
Erstelle Bubble Bay, eine spielbare Three.js-Wasserbomben-Arena, die sofort an klassische BnB-Spiele erinnert. Verwende standardmäßig detaillierte Tripo-Modelle und einen deutlich sichtbaren Umschalter zum Vergleich mit Three.js-Geometrie, ohne das Match zurückzusetzen. Nutze die bereitgestellten Original-Charakterreferenzen für Boz/Bazzi, Ike/Uni und Plunk/Keffy. Bewahre Gesichtszüge, Kopfbedeckungen, Farben, Kleidung und Körperproportionen, statt sie durch lose textgenerierte Interpretationen zu ersetzen.

 Erzeuge Charakter- und Pickup-Geometrie mit der Tripo CLI und explizit tripo-p2. Bereite neutrale, nach vorn gerichtete Referenzposen vor, generiere die Modelle, binde echte Biped-Skelette mit gültigen Skin-Weights und exportiere als GLB. Bewahre Task-IDs, Credits, originale geskinte Dateien und finale Hashes. Idle-, Lauf- und Sprunganimationen müssen tatsächliche Gelenke animieren. Korrigiere das Skinning von übergroßen Köpfen, Ohren und Handschuhen und überprüfe mehrere Ansichten sowie Bewegungsabläufe. Lokal erstellte Clips müssen korrekt beschrieben werden, nicht als Tripo-Presets. Die Rechte zur öffentlichen Nutzung der zugrunde liegenden Originalcharaktere müssen separat bestätigt werden; KI-Generierung ist keine Nutzungserlaubnis.

 Lokalisierte Namen: 宝宝 / 배찌 / Boz (Bazzi), 小乖 / 우니 / Ike (Uni), 胖墩 / 케피 / Plunk (Keffy). Startwerte für Kapazität/Reichweite/Geschwindigkeit: 1/1/5, 1/2/5, 1/2/4; Höchstwerte: 6/7/9, 6/7/8, 9/8/8. Wandle die Geschwindigkeit in 0.25 + Level*0.8 Welteinheiten pro Sekunde um; Kacheln sind 2 Einheiten groß. Bei der Auswahl eines Charakters werden die beiden anderen als unterschiedliche Rivalen mit passenden Profilen zugewiesen.

 Biete standardmäßig Pirate/Patrit14 im Format 15x13 sowie Village10 an. Bewahre das erkennbare goldene Deck, die gelbe Ladung, Holzkisten, vier Kanonen und den zentralen Mast; das Dorf besitzt vier farbige Wohnviertel, eine zentrale Straße, Hecken und Spielzeugblöcke. Nutze die Publisher-Karten als Referenz, erstelle die Runtime-Grafiken selbst und dokumentiere die kleinen Routenöffnungen, die für kontinuierliche 3D-Bewegung und die Flucht der KI erforderlich sind. Verwende helle Materialien, Schatten, eine Meereskulisse, eine klare Kamera-Führung und eine Übersichtsansicht.

 Ein Spieler tritt gegen zwei kooperierende KI-Rivalen an. WASD/Pfeiltasten bewegen die Figur, F platziert eine 2,5-Sekunden-Blase, mit der Leertaste springt man auf echte Plattformen, Shift führt einen Dash aus, Q/E drehen die Kamera, V wechselt die Ansicht und Escape pausiert. Wasser breitet sich kreuzförmig aus, berücksichtigt Hindernisse, zerstört den ersten weichen Block und verkettet Blasen. Implementiere das Fangen, die Flucht, das Fangen von Gegnern, Respawns, ein auswählbares Ziel von 3, 6, 9 oder 12 Fängen (Standard: 6) oder eine Wertung über 180 Sekunden sowie Ergebnisanzeige und Neustart. Touch-Joystick und Aktionsschaltflächen müssen gleichzeitig funktionieren.

 Verwende sechs generierte Tripo-Pickups: Ballon, Reichweiten-Trank, Rollschuh, Wurf-Handschuh, Trittstiefel und Rettungsnadel. Kisten lassen in 85 % der Fälle einen Gegenstand fallen. Bedingte Item-Gewichtungen: 30/30/30/2.5/3.5/4 %. Handschuhe gewähren drei zusätzliche Würfe, höchstens jedoch sechs. Mit G wirft man eine nahe Blase bis zu vier Kacheln weit über Hindernisse hinweg; Besitzer und ursprüngliche Zündzeit bleiben erhalten, die Landeposition wird reserviert und eine Flugbahn angezeigt. Läuft eine Blase während des Flugs ab, landet sie und explodiert. Mit K gleiten Blasen bis zum nächsten Hindernis, ohne die Zündzeit zurückzusetzen. Mit X wird eine Rettungsnadel verwendet; der Startwert ist eins, das Maximum drei. Zeige Inventar und verfügbare Steuerung deutlich an.

 Chinesische, englische und koreanische UI: Für Zeitzonen auf dem chinesischen Festland wird Chinesisch ausgewählt, für Korea und Nordkorea Koreanisch, für alle anderen Regionen einschließlich Hongkong, Macau und Taiwan Englisch. Eine manuelle Auswahl hat immer Vorrang. Akzeptiere nur GLB-Dateien mit eingebetteten Texturen, standardmäßiger unkomprimierter Speicherung und echtem Skinning bis 40 MB und 150k Dreiecken. Validiere Knochen, Gelenke und Weights, lehne statische Modelle ab, verwende vorhandene eingebettete Animationen und stelle für erkannte Humanoide ohne Clips grundlegende Gelenkbewegungen bereit. Nicht erkannte Skelette benötigen Animationen. Erkläre Rigging und Animation verständlich, biete eine Ausrichtungskorrektur um 90 Grad an, verarbeite alles lokal im Browser und weise anhand des Datei-Hashes stabile, ausgewogene Werte zu.

 Verwende für den Erstellungs-CTA genau https://studio.tripo3d.ai/?utm_source=satellite_invite&utm_medium=bubble-bay&utm_campaign=create-character. Verlinke jared mit https://x.com/jaredliu_bravo .

 Integriere 13 ElevenLabs-Soundeffekte mit Normalisierung, kurzem Ausklingen, Distanz-/Panoramaeffekt, Polyphonie-Limits, Lautstärkeregelung und Stummschaltung: Platzieren, Platzen, Kiste, Pickup, selten, Werfen, Landen, Fangen, Retten, Springen, Sieg, Niederlage, Kicken. Erstelle mit ElevenLabs music_v2_5 zwei eigene Instrumentalstücke von jeweils 90 Sekunden, passend zur nautischen Piratenkarte und zur sonnigen Nachbarschaft. Normalisiere sie auf ein zurückhaltendes Ziel von -20 LUFS und überblende die Loop-Übergänge. Gib der Musik eine eigene Lautstärkeregelung, wechsle die Tracks je nach Karte, blende beim Pausieren aus und berücksichtige die Master-Stummschaltung. Gib den Original-Soundtrack des Spiels nicht wieder.

 Halte unabhängigen Quellcode, Dependencies, Tests und die Herkunft der Assets außerhalb der CMS-Plattform-Apps. Bündele statische Ressourcen gleichen Ursprungs und MIT-Hinweise. Überprüfe echtes Desktop- und Touch-Gameplay, Upload-Varianten, Sprachen und den visuellen Wechsel in Ego Lite. Erstelle eine unveränderliche Review-Version, die an die bestehende CMS Web Page12 angehängt wird; bewahre die bestehende Live-Version, solange die Prüfung aussteht. Veröffentliche nur nach wahrheitsgemäßer Prüfung der Quellen und geklärten Asset-Rechte. Überprüfe anschließend die öffentliche URL, Modell-Hashes und das Verhalten. Bewahre die Historie und unterscheide gespeicherte CMS-Datensätze, Vorschauen und öffentliche Releases.

 Lade Modell-Assets mit sichtbarem Fortschritt, höchstens drei Downloads gleichzeitig, einem 30-sekündigen Leerlauf-Timeout und zwei Versuchen. Bewahre erfolgreiche Downloads bei einem erneuten Versuch. Verberge den gesamten Tripo-/Three.js-Tab-Umschalter, bis alle Modelle bereit sind, und zeige ihn erst danach an. Bezeichne prozedural geladene Platzhalter nicht als geladene Tripo-Modelle.


 Verwende eine nahe Perspektivkamera, die dem Spieler folgt und außerhalb des Spawn-Bereichs mit Blick auf die Arenamitte startet. Bewahre die Q/E-Kameradrehung, die Neigung per Mausziehen und die V-Übersicht. Platziere eine kompakte Punktetafel oben, den Moduswechsel oben links und kurze Hinweise am unteren Rand. Verberge Joystick und große Touch-Aktionen auf Desktop-Systemen mit Maus, behalte jedoch kleine Bedienelemente für seltene Items bei; unterstütze kompakte, gleichzeitig ausführbare Touch-Aktionen auf schmalen Bildschirmen. Füge einen animierten Wellen-Shader mit türkisfarbener Tiefenvariation, organische sandige Inselchen mit geschwungenen Palmen und Felsen, dezente Holzmaserung und Grastexturen hinzu. Schließe jeden gefangenen Charakter in eine größenangepasste, transluzente Blase mit schillerndem Fresnel-Rand, sanftem Schweben, kleinen Blasen und Bodenwellen ein. Überprüfe, ob die Scheitelpunkte des posierten Skins passen, setze den Lift beim Retten zurück und kontrolliere die Freigabe von Ressourcen nach wiederholtem Wechseln. Vermeide aufwendige Transmission-Pässe über die gesamte Szene für die Wasserhülle; begrenze die Pixelratio auf schmalen Bildschirmen auf 1.5.
