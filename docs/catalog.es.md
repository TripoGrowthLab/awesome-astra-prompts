...
<a href="https://www.tripo3d.ai/es/3d-prompts/bubble-bay"><img src="../assets/previews/3f9d3b8fcab4a54ff4bf19c6f25eb3f3ce6ce697cb929ab0abf86e89d6b8f708.jpg" width="840" loading="lazy" alt="Bubble Bay: Batalla 3D de globos de agua"></a>

<a href="https://www.tripo3d.ai/es/3d-prompts/bubble-bay"><img src="../assets/previews/a0927800e707bb993467cd9c9d32d7955cafcad0fe1ab3986c33d6bec6ce85f8.jpg" width="840" loading="lazy" alt="Bubble Bay: Batalla 3D de globos de agua"></a>

<a href="https://www.tripo3d.ai/es/3d-prompts/bubble-bay"><img src="../assets/previews/44f0d05c544d89c5044aece0e9da8cc3730bc51d81f395ff0e554bbceb4f2ab2.jpg" width="840" loading="lazy" alt="Bubble Bay: Batalla 3D de globos de agua"></a>

Crea una batalla clásica de globos de agua en 3D en Pirate14 y Village10, con tres personajes P2 animados, perspectiva cercana, burbujas trampa iridiscentes, objetivos de captura configurables, rivales controlados por IA, importación de personajes personalizados y música original de ElevenLabs. Establece seis capturas por defecto y muestra las pestañas de comparación solo después de la carga.

**Prompt**

```text
Crea Bubble Bay, una arena jugable de globos de agua en Three.js que recuerde de inmediato a los clásicos BnB. Usa por defecto modelos Tripo detallados, con un interruptor claramente visible para comparar la geometría de Three.js sin alterar la partida. Utiliza las referencias de personajes originales proporcionadas para Boz/Bazzi, Ike/Uni y Plunk/Keffy, y conserva sus rasgos faciales, accesorios de cabeza, colores, ropa y proporciones corporales, en lugar de sustituirlos por diseños generados mediante texto vagamente inspirados.

Genera la geometría de personajes y objetos recogibles con Tripo CLI usando explícitamente tripo-p2. Prepara poses de referencia neutras y frontales, genera los modelos, vincula esqueletos bípedos reales con pesos de skinning válidos y exporta en GLB. Conserva los ID de las tareas, los créditos, los archivos originales con skinning y los hashes finales. Las animaciones de reposo, carrera y salto deben animar articulaciones reales. Corrige el skinning de cabezas, orejas y guantes sobredimensionados, e inspecciona varias vistas y movimientos. Describe con precisión los clips creados localmente; no los presentes como preajustes de Tripo. Los derechos de uso público de los personajes originales requieren una confirmación independiente; la generación mediante IA no constituye un permiso.

Nombres localizados: 宝宝 / 배찌 / Boz (Bazzi), 小乖 / 우니 / Ike (Uni), 胖墩 / 케피 / Plunk (Keffy). Niveles iniciales de capacidad/alcance/velocidad: 1/1/5, 1/2/5, 1/2/4; límites máximos: 6/7/9, 6/7/8, 9/8/8. Convierte la velocidad a 0.25 + nivel*0.8 unidades del mundo por segundo; las casillas miden 2 unidades. Al elegir un personaje, asigna los otros dos como rivales distintos con perfiles equivalentes.

Ofrece por defecto Pirate/Patrit14 de 15x13 y Village10. Conserva la cubierta dorada reconocible, la carga amarilla, las cajas de madera, los cuatro cañones y el mástil central; la aldea cuenta con cuatro distritos residenciales de colores, una carretera central, setos y bloques de juguete. Usa los mapas del editor como referencia, construye tú mismo los elementos visuales en tiempo de ejecución y documenta las pequeñas aperturas de las rutas necesarias para el movimiento continuo en 3D y la evasión de la IA. Proporciona materiales luminosos, sombras, paisajes oceánicos, seguimiento de cámara claro y una vista general.

Un jugador se enfrenta a dos rivales de IA cooperativos. WASD/flechas mueven al personaje, F coloca una burbuja de 2.5 segundos, Espacio permite saltar sobre plataformas reales, Shift hace un desplazamiento rápido, Q/E orbitan la cámara, V cambia la vista y Escape pausa la partida. El agua en forma de cruz respeta los obstáculos, rompe el primer bloque blando y encadena las burbujas. Implementa trampas, escapes, capturas de enemigos, reapariciones y un objetivo seleccionable de 3, 6, 9 o 12 capturas (6 por defecto), o un modo de puntuación de 180 segundos, con resultado y opción de reintentar. El joystick táctil y los botones de acción deben funcionar simultáneamente.

Usa seis objetos recogibles generados con Tripo: globo, poción de alcance, patín, guante arrojadizo, bota de patada y aguja de rescate. Las cajas sueltan un objeto el 85 % de las veces. Pesos condicionales de los objetos: 30/30/30/2.5/3.5/4 %. Los guantes añaden tres lanzamientos, hasta un máximo de seis. G lanza una burbuja cercana hasta cuatro casillas por encima de obstáculos, conserva su propietario y la mecha original, reserva el punto de aterrizaje y muestra una trayectoria. Si una burbuja agota su tiempo mientras está en vuelo, aterriza y explota. K desliza las burbujas hasta que encuentran un bloqueo, sin reiniciar la mecha. X utiliza una aguja de rescate, con una cantidad inicial de uno y un máximo de tres. Muestra claramente el inventario y los controles disponibles.

Interfaz en chino, inglés y coreano: las zonas horarias IANA de China continental seleccionan chino; Corea y Corea del Norte seleccionan coreano; todas las demás, incluidas Hong Kong, Macao y Taiwán, seleccionan inglés. La elección manual siempre tiene prioridad. Permite subir únicamente archivos GLB con texturas incrustadas, estándar, sin compresión y con skinning real, de hasta 40 MB y 150k triángulos. Valida huesos, articulaciones y pesos; rechaza los modelos estáticos; usa las animaciones incrustadas cuando existan y proporciona un movimiento articular básico para humanoides reconocidos que no tengan clips. Los esqueletos no reconocidos necesitan animaciones. Explica con claridad la diferencia entre rigging y animación, ofrece un ajuste de orientación de 90 grados, procesa todo localmente en el navegador y asigna estadísticas estables y equilibradas a partir del hash del archivo.
...
Integra 13 efectos de sonido de ElevenLabs con normalización, decaimiento breve, distancia/paneo, límites de polifonía, volumen y silencio: colocar, estallar, caja, objeto recogible, raro, lanzar, aterrizar, trampa, rescate, salto, victoria, derrota y patada. Crea dos pistas instrumentales originales con ElevenLabs music_v2_5, de 90 segundos cada una, que correspondan al mapa pirata náutico y al vecindario soleado. Normalízalas a un objetivo moderado de -20 LUFS y aplica fundidos cruzados en los límites del bucle. Asigna a la música su propio control de volumen, cambia de pista según el mapa, aplica un fundido al pausar y respeta el silencio maestro. No reproduzcas la banda sonora del juego original.

Mantén el código fuente independiente, las dependencias, las pruebas y la procedencia de los recursos fuera de las aplicaciones de la plataforma CMS. Incluye los recursos estáticos del mismo origen y los avisos de MIT. Verifica el funcionamiento real en escritorio y táctil, las variantes de carga, los idiomas y el cambio visual en Ego Lite. Crea una versión de revisión inmutable vinculada a la Web Page12 existente del CMS; conserva la publicación activa existente mientras la revisión esté pendiente. Publica únicamente cuando la fuente y los derechos de los recursos estén autorizados de forma veraz; después, verifica la URL pública, los hashes de los modelos y el comportamiento. Conserva el historial y distingue entre los registros guardados del CMS, las vistas previas y las publicaciones públicas.

Carga los recursos de los modelos mostrando el progreso, con un máximo de tres descargas simultáneas, un tiempo de espera por inactividad de 30 segundos y dos intentos. Conserva las descargas correctas al reintentar. Oculta por completo el interruptor de pestañas Tripo / Three.js hasta que todos los modelos estén listos; después, muéstralo. No etiquetes los marcadores de posición de carga procedurales como modelos Tripo cargados.


Usa una cámara de seguimiento en perspectiva cercana que empiece fuera del punto de aparición y apunte hacia el centro de la arena. Conserva la órbita con Q/E, la inclinación mediante arrastre del ratón y la vista general con V. Mantén un marcador compacto en la parte superior, el interruptor de modo en la esquina superior izquierda y avisos breves cerca de la parte inferior. Oculta el joystick y las acciones táctiles grandes en equipos de escritorio con ratón, pero conserva los controles pequeños para objetos raros; admite acciones táctiles simultáneas y compactas en pantallas estrechas. Añade un shader de olas animado con variación de profundidad turquesa, islotes arenosos orgánicos con palmeras curvas y rocas, vetas de madera sutiles y texturas de hierba. Encierra a cada personaje atrapado en una burbuja translúcida adaptada a su tamaño, con un borde Fresnel iridiscente, flotación suave, burbujas pequeñas y ondas en el suelo. Verifica que los vértices con skinning se ajusten a las poses, restablece la elevación al rescatar a un personaje y comprueba la liberación de recursos tras cambiar de forma repetida. Evita los costosos pases de transmisión para toda la escena en la membrana de agua; limita a 1.5 la relación de píxeles en pantallas estrechas.
