...
- [Verdant — île aux dinosaures 3D interactive](#2101730386711634251)
- [Site web interactif présentant un modèle 3D du Soleil](#2102038136725377200)
- [Jeu de course procédural dans le navigateur — Spline Rush](#2102150615635816866)
- [Présentation interactive de conception d’un hélicoptère en 3D](#2102215638311694336)
- [Scène 3D et vidéo de la Tokyo Tower, de jour comme de nuit](#2102276620124062065)
...
<a href="https://www.tripo3d.ai/fr/3d-prompts/gpt-6-astra-2102038136725377200"><img src="../assets/previews/de0fe503b12a175ee365dbc43ba69d749366f428e25340c1eab2d624bdca1e91.jpg" width="840" loading="lazy" alt="Site web interactif présentant un modèle 3D du Soleil"></a>

Créez un site web interactif avec Three.js, centré sur un modèle 3D réaliste du Soleil réalisé à l’aide d’un script Python pour Blender. Le site doit permettre de faire pivoter le Soleil, de se déplacer autour de lui et d’effectuer un zoom avant ou arrière. Il doit inclure un arrière-plan cosmique, des informations sur le système solaire ainsi qu’une vue anatomique interactive présentant les différentes couches du Soleil avec leurs libellés et leurs descriptions.
...
<a href="https://www.tripo3d.ai/fr/3d-prompts/gpt-6-astra-2102150615635816866"><img src="../assets/previews/d06a545cb63d57f45d07a82b67de67e069fe38327d2f9d70f455bcaace9dc623.jpg" width="840" loading="lazy" alt="Jeu de course procédural dans le navigateur — Spline Rush"></a>

Prompt fourni mot pour mot dans le commentaire vérifié de l’auteur racine pour créer Spline Rush, un jeu de course procédural dans le navigateur avec Three.js, des circuits, des adversaires contrôlés par l’IA, une physique, des préréglages graphiques et une bande-son synthétisée.
...
<a href="https://www.tripo3d.ai/fr/3d-prompts/gpt-6-astra-2102215638311694336"><img src="../assets/previews/ca6e4dd6e911366689e5fe5542844b65935013f3b7e2feb51f9d9d1316956c65.jpg" width="840" loading="lazy" alt="Présentation interactive de conception d’un hélicoptère en 3D"></a>

L’auteur a partagé ce prompt dans un commentaire sur sa comparaison entre Grok 4.7 et ChatGPT-6 Astra. Il demande une présentation interactive d’un hélicoptère en 3D, accessible dans un navigateur, avec une géométrie procédurale, des caractéristiques aéronautiques détaillées, des livrées sélectionnables, des commandes de rotor, un mode vol stationnaire, des contrôles de caméra et une interface Three.js/WebGL adaptative.
...
<a href="https://www.tripo3d.ai/fr/3d-prompts/gpt-6-astra-2102276620124062065"><img src="../assets/previews/0491077ba77b62062c9bce879cb6c8f5a86f317c8d03acbb9792b8c6ed3c9c67.jpg" width="840" loading="lazy" alt="Scène 3D et vidéo de la Tokyo Tower, de jour comme de nuit"></a>

Consigne pour créer une scène en 3D représentant fidèlement la structure de la Tokyo Tower et l’atmosphère de ses environs, avec des versions de jour et de nuit. La livraison doit comprendre des données Blender modifiables, un fichier MP4 d’environ 30 secondes destiné à une publication sur X, des images de vérification et un README. L’auteur partage cette consigne comme prompt à utiliser avec Astra.
...
<a href="https://www.tripo3d.ai/fr/3d-prompts/bubble-bay"><img src="../assets/previews/3f9d3b8fcab4a54ff4bf19c6f25eb3f3ce6ce697cb929ab0abf86e89d6b8f708.jpg" width="840" loading="lazy" alt="Bubble Bay : bataille de ballons d’eau en 3D"></a>

<a href="https://www.tripo3d.ai/fr/3d-prompts/bubble-bay"><img src="../assets/previews/a0927800e707bb993467cd9c9d32d7955cafcad0fe1ab3986c33d6bec6ce85f8.jpg" width="840" loading="lazy" alt="Bubble Bay : bataille de ballons d’eau en 3D"></a>

<a href="https://www.tripo3d.ai/fr/3d-prompts/bubble-bay"><img src="../assets/previews/44f0d05c544d89c5044aece0e9da8cc3730bc51d81f395ff0e554bbceb4f2ab2.jpg" width="840" loading="lazy" alt="Bubble Bay : bataille de ballons d’eau en 3D"></a>

Créez une bataille classique de ballons d’eau en 3D sur Pirate14 et Village10, avec trois personnages P2 animés, une perspective rapprochée, des bulles-pièges irisées, des objectifs de capture configurables, des adversaires contrôlés par l’IA, l’import de personnages personnalisés et une musique originale d’ElevenLabs. Définissez six captures par défaut ; n’affichez les onglets de comparaison qu’après le chargement.

**Prompt**

```text
Créez Bubble Bay, une arène de ballons d’eau jouable en Three.js qui évoque immédiatement les classiques de BnB. Utilisez par défaut des modèles Tripo détaillés, avec un commutateur Three.js clairement visible pour comparer la géométrie, sans interrompre la partie. Utilisez les références originales fournies pour les personnages Boz/Bazzi, Ike/Uni et Plunk/Keffy, en conservant leurs traits du visage, couvre-chefs, couleurs, vêtements et proportions corporelles plutôt que de les remplacer par des designs générés à partir de texte qui s’en inspirent vaguement.

Générez la géométrie des personnages et des objets à ramasser avec Tripo CLI en utilisant explicitement tripo-p2. Préparez des poses de référence neutres, de face, générez les modèles, liez de vrais squelettes bipèdes avec des poids de skinning valides et exportez au format GLB. Conservez les identifiants de tâche, les crédits, les fichiers skinnés d’origine et les hachages finaux. Les animations d’attente, de course et de saut doivent animer de véritables articulations. Corrigez le skinning des têtes, oreilles et gants surdimensionnés, puis inspectez plusieurs vues et mouvements. Les clips créés localement doivent être décrits fidèlement, et non présentés comme des préréglages Tripo. Les droits d’utilisation publique des personnages originaux doivent faire l’objet d’une confirmation distincte ; la génération par IA ne constitue pas une autorisation.

Noms localisés : 宝宝 / 배찌 / Boz (Bazzi), 小乖 / 우니 / Ike (Uni), 胖墩 / 케피 / Plunk (Keffy). Niveaux initiaux de capacité/portée/vitesse : 1/1/5, 1/2/5, 1/2/4 ; plafonds : 6/7/9, 6/7/8, 9/8/8. Convertissez la vitesse en 0,25 + niveau*0,8 unité de monde par seconde ; les cases mesurent 2 unités. Le choix d’un personnage désigne les deux autres comme des adversaires distincts dotés de profils correspondants.

Proposez par défaut Pirate/Patrit14 en 15x13 et Village10. Conservez le pont doré reconnaissable, la cargaison jaune, les caisses en bois, les quatre canons et le mât central ; le village comporte quatre quartiers résidentiels colorés, une route centrale, des haies et des blocs-jouets. Utilisez les cartes du jeu original comme référence, construisez vous-même les éléments visuels à l’exécution et documentez les petites ouvertures de parcours nécessaires aux déplacements continus en 3D et aux échappées de l’IA. Fournissez des matériaux lumineux, des ombres, un décor marin, un suivi de caméra clair et une vue d’ensemble.

Un joueur affronte deux adversaires IA coopératifs. Les touches WASD/fléchées permettent de se déplacer, F pose une bulle de 2,5 secondes, Espace permet de sauter sur de vraies plateformes, Maj déclenche un dash, Q/E font orbiter la caméra, V change de vue et Échap met le jeu en pause. L’eau en forme de croix respecte les obstacles, détruit le premier bloc friable et enchaîne les bulles. Implémentez la capture, l’évasion, la capture des ennemis, les réapparitions, un objectif sélectionnable de 3, 6, 9 ou 12 captures (6 par défaut), ou un mode de score de 180 secondes, avec résultat et nouvelle tentative. Le joystick tactile et les boutons d’action doivent fonctionner simultanément.

Utilisez six objets à ramasser générés avec Tripo : ballon, potion de portée, patin à roulettes, gant de lancer, chaussure à coup de pied et aiguille de sauvetage. Les caisses libèrent un objet dans 85 % des cas. Poids conditionnels des objets : 30/30/30/2,5/3,5/4 %. Les gants ajoutent trois lancers, avec un maximum de six. G lance une bulle proche jusqu’à quatre cases par-dessus les obstacles, en conservant son propriétaire et sa mèche initiale, en réservant son point d’atterrissage et en affichant une trajectoire. Une bulle qui expire en vol atterrit et explose. K fait glisser les bulles jusqu’à ce qu’elles soient bloquées, sans réinitialiser la mèche. X utilise une aiguille de sauvetage, à partir d’une unité et jusqu’à un maximum de trois. Affichez clairement l’inventaire et les commandes disponibles.

Interface en chinois, anglais et coréen : les fuseaux horaires IANA de Chine continentale sélectionnent le chinois, ceux de Corée et de Corée du Nord sélectionnent le coréen, et tous les autres, notamment ceux de Hong Kong, Macao et Taïwan, sélectionnent l’anglais. Le choix manuel est toujours prioritaire. N’acceptez que les fichiers GLB avec textures intégrées, standard, non compressés et réellement skinnés, jusqu’à 40 MB et 150k triangles. Validez les os, les articulations et les poids, rejetez les modèles statiques, utilisez les animations intégrées lorsqu’elles existent et fournissez un mouvement articulaire de base pour les humanoïdes reconnus qui n’ont pas de clips. Les squelettes non reconnus doivent disposer d’animations. Expliquez clairement la différence entre rigging et animation, fournissez un réglage d’orientation à 90 degrés, effectuez le traitement localement dans le navigateur et attribuez des statistiques stables et équilibrées à partir du hachage du fichier.

Utilisez exactement https://studio.tripo3d.ai/?utm_source=satellite_invite&utm_medium=bubble-bay&utm_campaign=create-character pour l’appel à l’action de création. Créditez jared en créant un lien vers https://x.com/jaredliu_bravo .

Intégrez 13 effets sonores ElevenLabs avec normalisation, décroissance courte, distance/panoramique, limites de polyphonie, contrôle du volume et sourdine : pose, explosion, caisse, objet à ramasser, rare, lancer, atterrissage, capture, sauvetage, saut, victoire, défaite, coup de pied. Créez deux morceaux instrumentaux originaux avec ElevenLabs music_v2_5, de 90 secondes chacun, adaptés à la carte pirate maritime et au quartier ensoleillé. Normalisez-les avec une cible modérée de -20 LUFS et appliquez un fondu enchaîné aux points de boucle. Donnez à la musique son propre contrôle de volume, changez de morceau selon la carte, appliquez un fondu lors de la pause et respectez la sourdine générale. Ne reproduisez pas la bande-son du jeu original.

Conservez le code source indépendant, les dépendances, les tests et la provenance des ressources en dehors des applications de la plateforme CMS. Regroupez les ressources statiques de même origine et les mentions MIT. Vérifiez le gameplay réel sur ordinateur et écran tactile, les variantes à importer, les langues et le changement visuel dans Ego Lite. Créez une version de révision immuable rattachée à la page Web12 existante du CMS ; préservez la version actuellement en ligne pendant la révision. Ne publiez qu’après avoir vérifié fidèlement le code source et l’autorisation des ressources, puis vérifiez l’URL publique, les hachages des modèles et le comportement. Conservez l’historique et distinguez les enregistrements CMS sauvegardés, les aperçus et les versions publiques.

Chargez les ressources des modèles avec une progression visible, au plus trois téléchargements simultanés, un délai d’inactivité de 30 secondes et deux tentatives. Conservez les téléchargements réussis lors d’une nouvelle tentative. Masquez entièrement le commutateur d’onglets Tripo / Three.js jusqu’à ce que tous les modèles soient prêts, puis affichez-le. Ne présentez pas les espaces réservés de chargement procéduraux comme des modèles Tripo chargés.


Utilisez une caméra de suivi en perspective rapprochée qui démarre à l’extérieur de la zone de départ, orientée vers le centre de l’arène. Conservez l’orbite avec Q/E, l’inclinaison par glissement de la souris et la vue d’ensemble avec V. Placez un tableau des scores compact en haut, le commutateur de mode en haut à gauche et de brèves notifications près du bas. Masquez le joystick et les grandes commandes tactiles sur les ordinateurs contrôlés à la souris, tout en conservant les petites commandes des objets rares ; prenez en charge les actions tactiles simultanées et compactes sur les écrans étroits. Ajoutez un shader d’eau animé avec des variations de profondeur turquoise, des îlots de sable organiques bordés de palmiers et de rochers courbés, un grain de bois subtil et des textures d’herbe. Enfermez chaque personnage capturé dans une bulle translucide adaptée à sa taille, avec un contour Fresnel irisé, un léger flottement, de petites bulles et des ondulations au sol. Vérifiez que les sommets skinnés s’ajustent correctement en pose, réinitialisez la hauteur lors du sauvetage et contrôlez la libération des ressources après des changements répétés. Évitez les passes de transmission coûteuses à l’échelle de toute la scène pour la membrane aquatique ; plafonnez le ratio de pixels à 1,5 sur les écrans étroits.
...
<a href="https://www.tripo3d.ai/fr/3d-prompts/battle-city-3d"><img src="../assets/previews/e9180abfae92dc2319bb9b62f6ee89602336de5599b5f1c98f0feffeda618cdb.png" width="840" loading="lazy" alt="Battle City 3D : Défense de chars sans fin"></a>
...
<tr><td align="center">
<br>
<p><strong><a href="https://www.tripo3d.ai/fr/3d-prompts/models/gpt-6-astra?utm_source=github&amp;utm_medium=referral&amp;utm_campaign=awesome_astra_prompts&amp;utm_content=catalog_bottom">Voir les 271 exemples sur le site officiel →</a></strong></p>
