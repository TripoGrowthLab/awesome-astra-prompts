...
<a href="https://www.tripo3d.ai/it/3d-prompts/bubble-bay"><img src="../assets/previews/3f9d3b8fcab4a54ff4bf19c6f25eb3f3ce6ce697cb929ab0abf86e89d6b8f708.jpg" width="840" loading="lazy" alt="Bubble Bay: battaglia 3D con palloncini d’acqua"></a>

<a href="https://www.tripo3d.ai/it/3d-prompts/bubble-bay"><img src="../assets/previews/a0927800e707bb993467cd9c9d32d7955cafcad0fe1ab3986c33d6bec6ce85f8.jpg" width="840" loading="lazy" alt="Bubble Bay: battaglia 3D con palloncini d’acqua"></a>

<a href="https://www.tripo3d.ai/it/3d-prompts/bubble-bay"><img src="../assets/previews/44f0d05c544d89c5044aece0e9da8cc3730bc51d81f395ff0e554bbceb4f2ab2.jpg" width="840" loading="lazy" alt="Bubble Bay: battaglia 3D con palloncini d’acqua"></a>

Crea una classica battaglia 3D con palloncini d’acqua su Pirate14 e Village10, con tre personaggi P2 animati, prospettiva ravvicinata, bolle-trappola iridescenti, obiettivi di cattura configurabili, rivali IA, importazione di personaggi personalizzati e musica originale di ElevenLabs. Imposta il valore predefinito su sei catture; mostra le schede di confronto solo dopo il caricamento.

**Prompt**

```text
Crea Bubble Bay, un’arena giocabile con palloncini d’acqua in Three.js, che richiami immediatamente i classici BnB. Usa come impostazione predefinita modelli Tripo dettagliati, con un comando chiaramente visibile per confrontare la geometria Three.js, senza interrompere la partita. Usa i riferimenti originali forniti per i personaggi Boz/Bazzi, Ike/Uni e Plunk/Keffy, preservandone tratti del viso, copricapi, colori, abbigliamento e proporzioni del corpo, invece di sostituirli con design generati dal testo solo vagamente ispirati.

Genera la geometria dei personaggi e dei pickup con Tripo CLI usando esplicitamente tripo-p2. Prepara pose di riferimento neutre e frontali, genera i modelli, associa skeleton bipedi reali con skin weight validi ed esporta in GLB. Conserva gli ID delle attività, i crediti, i file originali skinnati e gli hash finali. Le animazioni di attesa, corsa e salto devono animare giunti reali. Correggi lo skinning di teste, orecchie e guanti sovradimensionati e controlla più viste e movimenti. I clip creati localmente devono essere descritti accuratamente, non come preset Tripo. I diritti di utilizzo pubblico dei personaggi originali richiedono una conferma separata; la generazione IA non costituisce un’autorizzazione.

Nomi localizzati: 宝宝 / 배찌 / Boz (Bazzi), 小乖 / 우니 / Ike (Uni), 胖墩 / 케피 / Plunk (Keffy). Livelli iniziali di capacità/raggio/velocità: 1/1/5, 1/2/5, 1/2/4; valori massimi: 6/7/9, 6/7/8, 9/8/8. Converti la velocità in 0.25 + livello*0.8 unità di mondo al secondo; le caselle misurano 2 unità. La scelta di un personaggio assegna gli altri due come rivali distinti, con profili corrispondenti.

Offri per impostazione predefinita Pirate/Patrit14 in formato 15x13 e Village10. Mantieni riconoscibili il ponte dorato, il carico giallo, le casse di legno, i quattro cannoni e l’albero centrale; il villaggio presenta quattro quartieri residenziali colorati, una strada centrale, siepi e blocchi giocattolo. Usa le mappe del publisher come riferimento, costruisci autonomamente gli elementi grafici a runtime e documenta le piccole aperture dei percorsi necessarie per il movimento 3D continuo e la fuga dell’IA. Fornisci materiali luminosi, ombre, scenari oceanici, un inseguimento della telecamera chiaro e una panoramica.

Un giocatore affronta due rivali IA cooperativi. WASD/frecce per muoversi, F per piazzare una bolla da 2,5 secondi, Spazio per saltare su piattaforme reali, Shift per lo scatto, Q/E per orbitare, V per cambiare visuale ed Esc per mettere in pausa. L’acqua a forma di croce deve rispettare gli ostacoli, rompere il primo blocco distruttibile e concatenare le bolle. Implementa intrappolamento, fuga, catture dei nemici, respawn, una selezione dell’obiettivo tra 3, 6, 9 o 12 catture (6 come valore predefinito), oppure il punteggio a tempo di 180 secondi, con risultato e possibilità di riprovare. Il joystick touch e i pulsanti d’azione devono funzionare contemporaneamente.

Usa sei pickup Tripo generati: palloncino, pozione del raggio, pattino a rotelle, guanto da lancio, stivale da calcio e ago di salvataggio. Le casse devono rilasciare un oggetto nell’85% dei casi. Probabilità condizionali degli oggetti: 30/30/30/2,5/3,5/4 percento. I guanti aggiungono tre lanci, fino a un massimo di sei. G lancia una bolla vicina fino a quattro caselle oltre le coperture, mantenendone il proprietario e la miccia originale, prenotandone il punto di atterraggio e mostrando una traiettoria ad arco. Se una bolla scade durante il volo, atterra ed esplode. K fa scivolare le bolle finché non incontrano un ostacolo, senza azzerare la miccia. X usa un ago di salvataggio, inizialmente pari a uno e con un massimo di tre. Mostra chiaramente l’inventario e i comandi disponibili.

Interfaccia in cinese, inglese e coreano: i fusi orari IANA della Cina continentale selezionano il cinese, quelli della Corea e della Corea del Nord selezionano il coreano; tutti gli altri, inclusi Hong Kong/Macao/Taiwan, selezionano l’inglese. La scelta manuale ha sempre la precedenza. Consenti il caricamento solo di file GLB con texture incorporate, standard, non compressi e realmente skinnati, fino a 40 MB e 150k triangoli. Convalida ossa, giunti e pesi, rifiuta i modelli statici, usa le animazioni incorporate quando presenti e fornisci un movimento articolare di base per gli umanoidi riconosciuti che non hanno clip. Gli skeleton non riconosciuti richiedono animazioni. Spiega chiaramente la differenza tra rigging e animazione, fornisci una regolazione dell’orientamento di 90 gradi, esegui l’elaborazione localmente nel browser e assegna statistiche stabili ed equilibrate in base all’hash del file.
...
Integra 13 effetti sonori ElevenLabs con normalizzazione, decadimento breve, distanza/pan, limiti di polifonia, volume e silenziamento: piazzamento, scoppio, cassa, pickup, raro, lancio, atterraggio, trappola, salvataggio, salto, vittoria, sconfitta, calcio. Crea due tracce strumentali originali con ElevenLabs music_v2_5, di 90 secondi ciascuna, abbinate alla mappa piratesca nautica e al quartiere soleggiato. Normalizzale a un obiettivo contenuto di -20 LUFS e applica un crossfade ai punti di loop. Assegna alla musica un controllo del volume indipendente, cambia traccia in base alla mappa, applica una dissolvenza durante la pausa e rispetta il silenziamento principale. Non riprodurre la colonna sonora originale del gioco.

Mantieni codice sorgente, dipendenze, test e provenienza degli asset indipendenti dalle app della piattaforma CMS. Includi risorse statiche same-origin e note MIT. Verifica il gameplay reale su desktop e touch, le varianti di caricamento, le lingue e il cambio visuale in Ego Lite. Crea una versione di revisione immutabile collegata all’elemento CMS Web Page12 esistente; conserva la release live esistente mentre la revisione è in sospeso. Pubblica solo dopo aver verificato con precisione il codice sorgente e i diritti sugli asset, quindi verifica l’URL pubblico, gli hash dei modelli e il comportamento. Conserva la cronologia e distingui tra record CMS salvati, anteprime e release pubbliche.

Carica gli asset dei modelli mostrando l’avanzamento, con un massimo di tre download simultanei, timeout di inattività di 30 secondi e due tentativi. Conserva i download riusciti durante i nuovi tentativi. Nascondi completamente il selettore delle schede Tripo / Three.js finché tutti i modelli non sono pronti, poi mostralo. Non etichettare i placeholder procedurali di caricamento come modelli Tripo caricati.


Usa una telecamera d’inseguimento con prospettiva ravvicinata, inizialmente all’esterno dello spawn e rivolta verso il centro dell’arena. Mantieni l’orbita Q/E, l’inclinazione tramite trascinamento del mouse e la panoramica V. Mantieni un tabellone compatto in alto, il selettore della modalità in alto a sinistra e brevi notifiche nella parte inferiore. Nascondi joystick e grandi comandi touch sui desktop con mouse, mantenendo i piccoli comandi per gli oggetti rari; supporta azioni touch simultanee e compatte sugli schermi stretti. Aggiungi uno shader animato per le onde con variazioni di profondità color teal, isolotti sabbiosi organici con palme ricurve e rocce, sottili texture delle venature del legno ed erba. Racchiudi ogni personaggio intrappolato in una bolla traslucida adattata alle sue dimensioni, con bordo Fresnel iridescente, lieve galleggiamento, piccole bolle e increspature sul terreno. Verifica che i vertici skinnati nelle pose aderiscano correttamente, azzera il sollevamento durante il salvataggio e controlla il rilascio delle risorse dopo cambi ripetuti. Evita pass costosi di trasmissione sull’intera scena per la membrana d’acqua; limita a 1.5 il pixel ratio sugli schermi stretti.
