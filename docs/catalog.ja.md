...
- [キュクロプスの島：アイソメトリック3Dブラウザゲーム](#2099414001851449430)
...
### キュクロプスの島：アイソメトリック3Dブラウザゲーム

[Jason Chew](https://x.com/jasoncjs_) · 2026-09-14

<a href="https://www.tripo3d.ai/ja/3d-prompts/gpt-6-astra-2099414001851449430"><img src="../assets/previews/09544f1dda48f4288384850cffc3a8d4127273075bba899a6d5691ac2c90d730.jpg" width="840" loading="lazy" alt="キュクロプスの島：アイソメトリック3Dブラウザゲーム"></a>

ホメロスの『オデュッセイア』に登場するキュクロプスの島を舞台にした、完全なインタラクティブブラウザゲーム向けの再利用可能なGPT-6 Astraプロンプト。Jason Chewが投稿したもので、オデュッセウスと仲間たち、キュクロプス、沖合の船、プレイヤー移動、衝突判定、カメラ操作、アニメーション、文学作品をモチーフにした目標UIを備えた、アイソメトリックなピクセルアート調のギリシャの島の3Dジオラマを求めています。

**プロンプト**

```text
ホメロスの『オデュッセイア』――キュクロプスの島を題材にした、インタラクティブなブラウザ体験を構築してください。

アニメーションする海に囲まれた、小さなギリシャの島を、洗練されたアイソメトリックなピクセルアート調の3Dジオラマとして制作します。砂浜、鬱蒼とした森、岩だらけの崖、大きな洞窟、オデュッセウスと仲間たち、キュクロプス、沖合の船を配置してください。

小規模ながらプレイ可能なゲームとして仕上げます。

WASDキーまたは矢印キーでオデュッセウスを操作
地面をクリックして歩かせる
ドラッグでカメラをパン
スクロールでズーム
水面、木々、キャラクター、環境に控えめなアニメーションを追加
カメラの回転、ズーム、視点リセット、一時停止の操作を追加
岩、木、水の中をプレイヤーが通り抜けられないよう、衝突判定を実装

画面左下に、暗いトーンの文学的なUIパネルを追加します。

「砂浜の道に沿ってオデュッセウスを洞窟まで導こう。」
その下に、現在のキャラクターと移動状態を表示します。
アートディレクション：1990年代のアイソメトリックなストラテジー／RPGのピクセルアートを思わせる精密な表現、彩度を抑えた地中海カラー、質感のある地形、温かみのある羊皮紙風のタイポグラフィ、控えめな粒子感、そして上質なゲームUI。命を吹き込まれた古い絵地図のように見せてください。
体験全体をブラウザウィンドウいっぱいに表示し、すぐに動作するようにします。モックアップにはせず、完全なインタラクティブ体験を構築してください。
```

[詳細を見る ↗](https://www.tripo3d.ai/ja/3d-prompts/gpt-6-astra-2099414001851449430) · [元の投稿](https://x.com/jasoncjs_/status/2099414001851449430) · [作例一覧に戻る](#all-prompts)
...
<tr><td align="center">
<br>
<p><strong><a href="https://www.tripo3d.ai/ja/3d-prompts/models/gpt-6-astra?utm_source=github&amp;utm_medium=referral&amp;utm_campaign=awesome_astra_prompts&amp;utm_content=catalog_bottom">全 235 件の作例を公式サイトで見る →</a></strong></p>
