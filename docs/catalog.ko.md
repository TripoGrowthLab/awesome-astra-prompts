...
- [키클롭스의 섬 아이소메트릭 3D 브라우저 게임](#2099414001851449430)
...
### 키클롭스의 섬 아이소메트릭 3D 브라우저 게임

[Jason Chew](https://x.com/jasoncjs_) · 2026-09-14

<a href="https://www.tripo3d.ai/ko/3d-prompts/gpt-6-astra-2099414001851449430"><img src="../assets/previews/09544f1dda48f4288384850cffc3a8d4127273075bba899a6d5691ac2c90d730.jpg" width="840" loading="lazy" alt="키클롭스의 섬 아이소메트릭 3D 브라우저 게임"></a>

호메로스의 『오디세이아』에 등장하는 키클롭스의 섬을 배경으로 한 완성도 높은 인터랙티브 브라우저 게임 제작을 위해 Jason Chew가 게시한 재사용 가능한 GPT-6 Astra 프롬프트입니다. 오디세우스와 선원들, 키클롭스, 근해의 배, 플레이어 이동, 충돌, 카메라 조작, 애니메이션, 문학적 목표 UI를 포함한 아이소메트릭 픽셀 아트 3D 그리스 섬 디오라마를 요청합니다.

**프롬프트**

```text
호메로스의 『오디세이아』를 바탕으로 한 「키클롭스의 섬」 인터랙티브 브라우저 경험을 제작하세요.

애니메이션이 적용된 바다로 둘러싸인 작은 그리스 섬을 정교한 아이소메트릭 픽셀 아트 3D 디오라마로 구현하세요. 모래 해변, 울창한 숲, 바위 절벽, 커다란 동굴, 오디세우스와 선원들, 키클롭스, 앞바다의 배를 포함하세요.

작은 플레이 가능 게임처럼 느껴지도록 구성하세요.

WASD 또는 방향키로 오디세우스를 조작
지면을 클릭해 이동
드래그해 카메라 이동
스크롤해 확대 및 축소
물, 나무, 캐릭터, 환경에 은은한 애니메이션 추가
카메라 회전, 확대·축소, 화면 초기화, 일시정지 컨트롤 추가
충돌 처리를 적용해 플레이어가 바위, 나무, 물을 통과하지 못하게 구성

왼쪽 하단에 어두운 분위기의 문학적 UI 패널을 추가하세요.

“오디세우스를 이끌고 모래 길을 따라 동굴로 이동하세요.”
그 아래에 현재 캐릭터와 이동 상태를 표시하세요.
아트 디렉션: 1990년대 아이소메트릭 전략/RPG 픽셀 아트를 기반으로 세밀하게 표현하고, 채도가 낮은 지중해풍 색상, 질감이 살아 있는 지형, 따뜻한 양피지풍 타이포그래피, 은은한 그레인, 고급스러운 게임 UI를 사용하세요. 생생하게 움직이는 오래된 삽화 지도처럼 보여야 합니다.
전체 경험이 브라우저 창을 가득 채우고 즉시 작동하도록 하세요. 목업을 만들지 마세요. 완성된 인터랙티브 경험을 구현하세요.
```

[자세히 보기 ↗](https://www.tripo3d.ai/ko/3d-prompts/gpt-6-astra-2099414001851449430) · [원본 게시물](https://x.com/jasoncjs_/status/2099414001851449430) · [사례 목록으로](#all-prompts)
...
<tr><td align="center">
<br>
<p><strong><a href="https://www.tripo3d.ai/ko/3d-prompts/models/gpt-6-astra?utm_source=github&amp;utm_medium=referral&amp;utm_campaign=awesome_astra_prompts&amp;utm_content=catalog_bottom">공식 사이트에서 전체 사례 235개 보기 →</a></strong></p>
