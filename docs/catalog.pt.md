...
<a href="https://www.tripo3d.ai/pt/3d-prompts/bubble-bay"><img src="../assets/previews/3f9d3b8fcab4a54ff4bf19c6f25eb3f3ce6ce697cb929ab0abf86e89d6b8f708.jpg" width="840" loading="lazy" alt="Bubble Bay: Batalha 3D de Balões de Água"></a>

<a href="https://www.tripo3d.ai/pt/3d-prompts/bubble-bay"><img src="../assets/previews/a0927800e707bb993467cd9c9d32d7955cafcad0fe1ab3986c33d6bec6ce85f8.jpg" width="840" loading="lazy" alt="Bubble Bay: Batalha 3D de Balões de Água"></a>

<a href="https://www.tripo3d.ai/pt/3d-prompts/bubble-bay"><img src="../assets/previews/44f0d05c544d89c5044aece0e9da8cc3730bc51d81f395ff0e554bbceb4f2ab2.jpg" width="840" loading="lazy" alt="Bubble Bay: Batalha 3D de Balões de Água"></a>

Crie uma batalha clássica de balões d’água em 3D nos mapas Pirate14 e Village10, com três personagens P2 animados, perspectiva próxima, bolhas-armadilha iridescentes, alvos de captura configuráveis, rivais controlados por IA, importação de personagens personalizados e música original do ElevenLabs. O padrão deve ser de seis capturas; revele as abas de comparação somente após o carregamento.

**Prompt**

```text
Crie Bubble Bay, uma arena jogável de balões d’água em Three.js que remeta imediatamente ao clássico BnB. Use por padrão modelos Tripo detalhados, com uma chave evidente para comparar a geometria do Three.js sem interromper a partida. Use as referências originais fornecidas dos personagens Boz/Bazzi, Ike/Uni e Plunk/Keffy, preservando traços faciais, acessórios de cabeça, cores, roupas e proporções corporais, em vez de substituí-los por designs gerados por texto apenas vagamente inspirados.

Gere a geometria dos personagens e dos itens coletáveis com a Tripo CLI usando explicitamente tripo-p2. Prepare poses de referência neutras, de frente, gere os modelos, vincule esqueletos bípedes reais com pesos de skinning válidos e exporte em GLB. Preserve os IDs das tarefas, os créditos, os arquivos originais com skinning e os hashes finais. As animações de idle, corrida e salto devem movimentar juntas reais. Corrija o skinning desproporcional de cabeças, orelhas e luvas grandes e inspecione várias vistas e movimentos. Os clipes criados localmente devem ser descritos com precisão, sem apresentá-los como presets do Tripo. Os direitos de uso público dos personagens originais exigem confirmação separada; gerar com IA não constitui permissão.

Nomes localizados: 宝宝 / 배찌 / Boz (Bazzi), 小乖 / 우니 / Ike (Uni), 胖墩 / 케피 / Plunk (Keffy). Níveis iniciais de capacidade/alcance/velocidade: 1/1/5, 1/2/5, 1/2/4; limites máximos: 6/7/9, 6/7/8, 9/8/8. Converta a velocidade para 0,25 + nível*0,8 unidade do mundo por segundo; cada bloco mede 2 unidades. Ao escolher um personagem, atribua os outros dois como rivais distintos, com os perfis correspondentes.

Ofereça por padrão Pirate/Patrit14 em uma grade de 15x13 e Village10. Preserve o convés dourado reconhecível, a carga amarela, as caixas de madeira, os quatro canhões e o mastro central; a vila tem quatro distritos residenciais coloridos, uma estrada central, cercas-vivas e blocos de brinquedo. Use os mapas do publicador como referência, construa a arte de execução por conta própria e documente as pequenas aberturas de rota necessárias para o movimento contínuo em 3D e a fuga da IA. Forneça materiais vibrantes, sombras, cenário oceânico, acompanhamento claro da câmera e visão geral.

Um jogador enfrenta dois rivais de IA cooperativos. WASD/setas movimentam, F posiciona uma bolha de 2,5 segundos, Espaço salta sobre plataformas reais, Shift dá uma arrancada, Q/E orbitam, V muda a visão e Esc pausa. A água em formato de cruz respeita os obstáculos, quebra o primeiro bloco destrutível e encadeia bolhas. Implemente aprisionamento, fuga, capturas por inimigos, reaparecimentos, um alvo selecionável de 3, 6, 9 ou 12 capturas (padrão: 6) ou pontuação por 180 segundos, além de resultado e nova tentativa. O joystick e os botões de ação por toque devem funcionar simultaneamente.

Use seis itens coletáveis gerados pelo Tripo: balão, poção de alcance, patins, luva de arremesso, bota de chute e agulha de resgate. As caixas devem soltar um item em 85% das vezes. Pesos condicionais dos itens: 30/30/30/2,5/3,5/4%. As luvas acrescentam três arremessos, com limite de seis. G lança uma bolha próxima a até quatro blocos de distância por cima de coberturas, preservando seu dono e o pavio original, reservando o local de pouso e exibindo uma trajetória. Se uma bolha expirar durante o voo, ela pousa e explode. K desliza as bolhas até serem bloqueadas, sem reiniciar o pavio. X usa uma agulha de resgate, começando com uma e com limite de três. Exiba claramente o inventário e os controles disponíveis.

Interface em chinês, inglês e coreano: fusos horários IANA da China continental selecionam chinês, os da Coreia do Sul/Coreia do Norte selecionam coreano e todos os demais, incluindo Hong Kong/Macau/Taiwan, selecionam inglês. A escolha manual sempre prevalece. Aceite apenas arquivos GLB com textura incorporada, padrão, sem compressão e com skinning real, de até 40 MB e 150 mil triângulos. Valide ossos, juntas e pesos; rejeite modelos estáticos; use as animações incorporadas quando existirem e forneça movimentos básicos das juntas para humanoides reconhecidos que não tenham clipes. Esqueletos não reconhecidos precisam de animações. Explique claramente a diferença entre rigging e animação, forneça um ajuste de orientação de 90 graus, processe tudo localmente no navegador e atribua atributos estáveis e equilibrados com base no hash do arquivo.

Use exatamente https://studio.tripo3d.ai/?utm_source=satellite_invite&utm_medium=bubble-bay&utm_campaign=create-character como CTA de criação. Dê crédito a jared, vinculando a https://x.com/jaredliu_bravo .

Integre 13 efeitos sonoros do ElevenLabs com normalização, decaimento curto, distância/panorama, limites de polifonia, volume e mudo: posicionar, explosão, caixa, item coletável, raro, arremesso, pouso, armadilha, resgate, salto, vitória, derrota e chute. Crie duas faixas instrumentais originais com ElevenLabs music_v2_5, de 90 segundos cada, correspondentes ao mapa pirata náutico e ao bairro ensolarado. Normalize-as para um alvo controlado de -20 LUFS e faça crossfade nos pontos de loop. Dê à música um controle de volume próprio, altere as faixas conforme o mapa, aplique fade ao pausar e respeite o mudo mestre. Não reproduza a trilha sonora do jogo original.

Mantenha o código-fonte independente, as dependências, os testes e a procedência dos assets fora dos aplicativos da plataforma CMS. Empacote recursos estáticos da mesma origem e avisos de licença MIT. Verifique a jogabilidade real em desktop e toque, as variantes de upload, os idiomas e a troca visual no Ego Lite. Crie uma versão imutável para revisão vinculada à Web Page12 existente do CMS; preserve a versão publicada atual enquanto a revisão estiver pendente. Publique somente com a fonte verdadeira e a liberação dos direitos dos assets confirmadas; depois, verifique a URL pública, os hashes dos modelos e o comportamento. Preserve o histórico e diferencie registros salvos no CMS, prévias e versões públicas.

Carregue os assets dos modelos com progresso visível, no máximo três downloads simultâneos, tempo limite de inatividade de 30 segundos e duas tentativas. Preserve os downloads bem-sucedidos ao tentar novamente. Oculte toda a chave de abas Tripo/Three.js até que todos os modelos estejam prontos; só então revele-a. Não rotule placeholders de carregamento procedurais como modelos Tripo carregados.


Use uma câmera de acompanhamento em perspectiva próxima, iniciando fora da área de spawn e voltada para o centro da arena. Preserve a órbita com Q/E, a inclinação ao arrastar o mouse e a visão geral com V. Mantenha um placar compacto no topo, a chave de modo no canto superior esquerdo e avisos breves próximos à parte inferior. Oculte o joystick e as ações de toque grandes em desktops com mouse, mantendo controles pequenos para itens raros; ofereça ações de toque simultâneas e compactas em telas estreitas. Adicione um shader de ondas animado com variação de profundidade em tons de teal, ilhotas arenosas orgânicas com palmeiras curvas e rochas, além de texturas sutis de veios da madeira e grama. Envolva cada personagem preso em uma bolha translúcida dimensionada de acordo com seu tamanho, com uma borda Fresnel iridescente, flutuação suave, bolhas pequenas e ondulações no chão. Verifique se os vértices com skinning em pose se ajustam corretamente, redefina a elevação ao resgatar e confira a liberação de recursos após trocas repetidas. Evite passes de transmissão caros em toda a cena para a membrana de água; limite a proporção de pixels a 1,5 em telas estreitas.
