...
<a href="https://www.tripo3d.ai/ru/3d-prompts/bubble-bay"><img src="../assets/previews/3f9d3b8fcab4a54ff4bf19c6f25eb3f3ce6ce697cb929ab0abf86e89d6b8f708.jpg" width="840" loading="lazy" alt="Bubble Bay: 3D-битва водяных шаров"></a>

<a href="https://www.tripo3d.ai/ru/3d-prompts/bubble-bay"><img src="../assets/previews/a0927800e707bb993467cd9c9d32d7955cafcad0fe1ab3986c33d6bec6ce85f8.jpg" width="840" loading="lazy" alt="Bubble Bay: 3D-битва водяных шаров"></a>

<a href="https://www.tripo3d.ai/ru/3d-prompts/bubble-bay"><img src="../assets/previews/44f0d05c544d89c5044aece0e9da8cc3730bc51d81f395ff0e554bbceb4f2ab2.jpg" width="840" loading="lazy" alt="Bubble Bay: 3D-битва водяных шаров"></a>

Создайте классическую 3D-битву на водяных шариках на картах Pirate14 и Village10: три анимированных персонажа P2, камера с близкой перспективой, переливающиеся ловушки-пузыри, настраиваемое число захватов, соперники под управлением ИИ, импорт пользовательских персонажей и оригинальная музыка ElevenLabs. По умолчанию установите шесть захватов; вкладки сравнения показывайте только после загрузки.

**Промпт**

```text
Создайте Bubble Bay — игровую арену на водяных шариках в Three.js, которая сразу напоминает классическую BnB. По умолчанию используйте детализированные модели Tripo и добавьте очевидный переключатель сравнения геометрии Three.js, не прерывающий матч. Используйте предоставленные оригинальные референсы персонажей Boz/Bazzi, Ike/Uni и Plunk/Keffy, сохраняя черты лица, головные уборы, цвета, одежду и пропорции тела, а не заменяя их на условно похожие дизайны, сгенерированные по текстовому описанию.

Генерируйте геометрию персонажей и предметов с помощью Tripo CLI, явно указывая tripo-p2. Подготовьте нейтральные фронтальные позы для референсов, сгенерируйте модели, привяжите настоящие двуногие скелеты с корректными весами скиннинга и экспортируйте GLB. Сохраняйте идентификаторы задач, кредиты, исходные файлы со скиннингом и финальные хеши. Анимации покоя, бега и прыжка должны задействовать реальные суставы. Исправьте скиннинг слишком большой головы, ушей и перчаток, затем проверьте модель с нескольких ракурсов и в движении. Короткие клипы, созданные локально, описывайте точно, не выдавая их за пресеты Tripo. Права на публичное использование оригинальных персонажей требуют отдельного подтверждения; генерация ИИ не является разрешением.

Локализованные имена: 宝宝 / 배찌 / Boz (Bazzi), 小乖 / 우니 / Ike (Uni), 胖墩 / 케피 / Plunk (Keffy). Начальные значения вместимости/дальности/скорости: 1/1/5, 1/2/5, 1/2/4; максимальные значения: 6/7/9, 6/7/8, 9/8/8. Переводите скорость в 0,25 + уровень × 0,8 мировых единиц в секунду; размер клетки — 2 единицы. При выборе персонажа назначайте двух остальных уникальными соперниками с соответствующими профилями.

По умолчанию предложите Pirate/Patrit14 размером 15×13 и Village10. Сохраните узнаваемую золотую палубу, жёлтый груз, деревянные ящики, четыре пушки и центральную мачту; на деревенской карте должны быть четыре цветных жилых района, центральная дорога, живые изгороди и игрушечные блоки. Используйте карты издателя как референс, самостоятельно создавайте ресурсы для выполнения в рантайме и документируйте небольшие проходы, необходимые для непрерывного 3D-передвижения и побега ИИ. Добавьте яркие материалы, тени, океанский пейзаж, понятное следование камеры и обзорный режим.

Один игрок сражается с двумя сообщающимися соперниками под управлением ИИ. Перемещение — WASD/стрелки, F устанавливает пузырь на 2,5 секунды, Space запрыгивает на настоящие платформы, Shift выполняет рывок, Q/E вращают камеру по орбите, V меняет вид, Escape ставит игру на паузу. Вода распространяется крестом с учётом препятствий, разрушает первый мягкий блок и соединяет пузыри в цепную реакцию. Реализуйте захват в пузырь, освобождение, захваты врагами, возрождение, выбор цели: 3, 6, 9 или 12 захватов (по умолчанию 6), либо подсчёт очков за 180 секунд, экран результата и повторную попытку. Виртуальный джойстик и кнопки действий должны работать одновременно.

Используйте шесть сгенерированных предметов Tripo: воздушный шарик, зелье дальности, роликовый конёк, перчатку для броска, ботинок для удара и иглу спасения. В 85% случаев из ящиков должен выпадать предмет. Условные веса предметов: 30/30/30/2,5/3,5/4%. Перчатки добавляют три броска, максимум — шесть. G бросает ближайший пузырь на расстояние до четырёх клеток поверх укрытий, сохраняя его владельца и исходный таймер, резервирует место приземления и показывает траекторию дугой. Если пузырь истекает в полёте, он приземляется и взрывается. K скользит пузырями до столкновения с препятствием, не сбрасывая таймер. X использует иглу спасения: начальное количество — 1, максимум — 3. Понятно отображайте инвентарь и доступные управления.

Интерфейс на китайском, английском и корейском языках: часовые пояса IANA материкового Китая выбирают китайский, Кореи и Северной Кореи — корейский, все остальные, включая Гонконг, Макао и Тайвань, — английский. Ручной выбор всегда имеет приоритет. Разрешайте загружать только GLB со встроенными текстурами, стандартным несжатым форматом и настоящим скиннингом, размером до 40 МБ и объёмом до 150 тыс. треугольников. Проверяйте кости, суставы и веса, отклоняйте статичные модели, используйте встроенные анимации, если они есть, и добавляйте базовое движение суставов распознанным гуманоидным моделям без клипов. Для нераспознанных скелетов необходимы анимации. Понятно объясняйте разницу между риггингом и анимацией, добавьте корректировку ориентации на 90 градусов, выполняйте обработку локально в браузере и назначайте стабильные сбалансированные характеристики по хешу файла.

Используйте ровно https://studio.tripo3d.ai/?utm_source=satellite_invite&utm_medium=bubble-bay&utm_campaign=create-character для CTA создания. Укажите jared со ссылкой на https://x.com/jaredliu_bravo.

Интегрируйте 13 звуковых эффектов ElevenLabs с нормализацией, коротким затуханием, учётом расстояния и панорамирования, ограничением полифонии, регулировкой громкости и отключением звука: установка, взрыв, ящик, подбор, редкий предмет, бросок, приземление, ловушка, спасение, прыжок, победа, поражение, удар ногой. Создайте две оригинальные инструментальные композиции с помощью ElevenLabs music_v2_5, по 90 секунд каждая, в духе пиратской карты с морской тематикой и солнечного жилого района. Нормализуйте их до сдержанного целевого уровня −20 LUFS и сделайте кроссфейд на границах зацикливания. Предусмотрите отдельную регулировку громкости музыки, меняйте треки в зависимости от карты, плавно приглушайте музыку на паузе и учитывайте общий мут. Не воспроизводите оригинальный саундтрек игры.

Храните независимый исходный код, зависимости, тесты и сведения о происхождении ресурсов за пределами приложений CMS-платформы. Собирайте статические ресурсы с того же источника и уведомления MIT. Проверьте реальный игровой процесс на компьютере и сенсорных устройствах, варианты загрузки, языки и визуальное переключение в Ego Lite. Создайте неизменяемую версию для проверки, прикреплённую к существующей CMS Web Page12; пока проверка не завершена, сохраняйте текущую опубликованную версию. Публикуйте только после достоверной проверки исходного кода и прав на ресурсы, затем проверьте публичный URL, хеши моделей и поведение. Сохраняйте историю и различайте сохранённые записи CMS, предпросмотры и публичные релизы.

Загружайте ресурсы моделей с видимым индикатором прогресса, одновременно выполняя не более трёх загрузок; установите тайм-аут бездействия 30 секунд и две попытки. Успешно загруженные ресурсы сохраняйте при повторной попытке. Скрывайте весь переключатель вкладок Tripo / Three.js, пока все модели не будут готовы, а затем показывайте его. Не помечайте процедурные заглушки загрузки как загруженные модели Tripo.


Используйте камеру слежения с близкой перспективой: при старте она должна находиться за пределами стартовой зоны и смотреть в центр арены. Сохраните орбитальное вращение Q/E, наклон перетаскиванием мыши и обзорный режим V. Разместите компактное табло сверху, переключатель режима — в левом верхнем углу, а краткие уведомления — внизу. На настольных устройствах с мышью скрывайте джойстик и крупные сенсорные кнопки, сохраняя небольшие элементы управления для редких предметов; на узких экранах поддерживайте компактные одновременные сенсорные действия. Добавьте анимированный шейдер волн с изменением глубины в бирюзовых тонах, органичные песчаные островки с изогнутыми пальмами и камнями, ненавязчивые текстуры древесных волокон и травы. Окружайте каждого персонажа, пойманного в ловушку, полупрозрачным пузырём с учётом его размера, переливающейся каймой Fresnel, лёгким плаванием, мелкими пузырьками и рябью на поверхности. Проверьте, что вершины скиннинга в позе соответствуют модели, сбрасывайте подъём после спасения и проверяйте освобождение ресурсов после многократного переключения. Не используйте дорогие проходы передачи для всей сцены ради водяной мембраны; ограничьте коэффициент плотности пикселей на узких экранах значением 1,5.
