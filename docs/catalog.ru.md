...
<a href="https://www.tripo3d.ai/ru/3d-prompts/bubble-bay"><img src="../assets/previews/5158051d1bd3d80bc65cbfdd00a31c6e9c048c21f0e18ed7b1826972c94b6b5d.webp" width="840" loading="lazy" alt="Bubble Bay: 3D-битва водяных шаров"></a>

<a href="https://www.tripo3d.ai/ru/3d-prompts/bubble-bay"><img src="../assets/previews/ceda95626d7f2a404ab04a28ea483f2da5eb9cc367184a09da386305cc85539a.png" width="840" loading="lazy" alt="Bubble Bay: 3D-битва водяных шаров"></a>

Создайте солнечную 3D-битву во дворе с водяными шарами, прыжками, противниками под управлением ИИ и собственным анимированным персонажем. Переключайтесь между моделями Tripo и геометрической версией на Three.js.

**Промпт**

```text
1. Цель проекта
Создайте Bubble Bay — игровую 3D-битву водяных шаров в солнечном игрушечном городском дворе. Игрок управляет одним персонажем синей команды и сражается против двух противников красной команды под управлением ИИ. Перемещайтесь по дорожкам, разбивайте ящики, собирайте усиления, запрыгивайте на платформы и запирайте противников в пузырях. Победа присуждается за три захвата противоположной команды в течение трёхминутного матча. Подготовьте полноценную игру на Three.js с наглядным сравнением визуальных режимов и мастерской для добавления собственного персонажа с ригом.

2. Визуальное направление
Используйте приложенные скриншоты двора и запись игрового процесса как ориентир для целевой версии. Создайте камеру от третьего лица с близкой перспективой и углом обзора около 51 градуса, которая плавно следует за персонажем сверху и сзади. Игровое пространство должно заполнять экран. Используйте мощение из кремня, медово-жёлтые деревянные ящики, клумбы из красного кирпича, синие и терракотовые крыши коттеджей, округлые зелёные деревья и группы небольших цветов. Сделайте силуэты трёх персонажей легко различимыми, а поверхности — текстурированными и мягко затенёнными. Добавьте тёплый направленный солнечный свет, мягкие контактные тени, лёгкий туман, умеренные блики воды в стиле bloom и прозрачные синие пузыри. Счёт, таймер, элементы управления и противники должны оставаться хорошо различимыми на фоне детализированной сцены.
На главном экране разместите компактный выбор персонажа слева, три индикатора характеристик, варианты сложности и заметную кнопку начала игры. В верхней центральной части выделите режимы визуализации Tripo и Three.js; при переключении одновременно меняйте подписи, оформление выбранного режима и отображаемые модели. По умолчанию используйте режим Tripo. Во время игры сократите интерфейс до счёта команд, таймера, маркера игрока, текущих характеристик и подсказок по управлению. Используйте центральную панель результатов со счётом, лучшим результатом, действиями для повтора игры и перехода в мастерскую персонажей.

3. Мир и планировка
Создайте прямоугольный двор размером примерно 22 на 24 мировые единицы с ячейками, расположенными через каждые 2 единицы. Оставьте свободную центральную дорожку с севера на юг и безопасную стартовую зону у южной границы. Чередуйте сплошные клумбы и разрушаемые ящики вдоль соединённых маршрутов. Разместите коттеджи, деревья и цветы по периметру, не загораживая игровую область. Используйте простые коллайдеры, независимые от детализированных декоративных мешей. Высота опорной части клумб должна составлять 1.02 единицы, а ящиков — 1.72 единицы. Персонаж должен действительно приземляться на их верхние поверхности и падать, сходя с них. После разрушения ящики исчезают, открывая новые маршруты. Разместите игрока ближе к южной границе, а двух противников — в северной половине. Обеспечьте доступность начальных усилений и меняйте расположение ящиков между матчами.

4. Список ассетов
Используйте независимые заменяемые слоты GLB с согласованными габаритами, ориентацией и точками опоры на земле. В первую очередь подготовьте персонажей, затем повторяющиеся ящики и коттеджи, а после — растительность.
- hero: Blue — стандартный синий мультяшный искатель приключений с округлой головой и компактным телом. Один персонаж с ригом, по умолчанию игрок синей команды; необходимы анимации покоя, бега и прыжка.
- mint: Mint — небольшое бирюзовое фантазийное существо с розовыми акцентами на голове. Один персонаж с ригом, доступный для выбора игроком и использования противником; необходимы анимации покоя и бега.
- mango: Mango — оранжевый маскот, похожий на животное, с кремовой мордочкой и животом. Один персонаж с ригом, доступный для выбора игроком и использования противником; необходимы анимации покоя и бега.
- cottage: Небольшой коттедж с кремовыми стенами и массивной двускатной крышей, покрытой черепицей. Повторяйте его по границе; переиспользуйте геометрию и применяйте варианты крыш синего или терракотового цвета.
- crate: Медово-жёлтый деревянный ящик с деталями из досок и прочным силуэтом. Повторяйте его в разрушаемых ячейках; после разрушения или при осмотре под разными углами сохраняйте закрытую видимую внутреннюю часть.
- tree: Невысокое стилизованное дерево с толстым стволом и округлой многоярусной листвой. Повторяйте его за границей двора.
- bush: Низкая зелёная растительность с небольшими разноцветными цветами. Повторяйте её внутри клумб и вокруг домов.
Сделайте мощение, кирпичную кладку клумб, небо, источники света, прокси-коллайдеры, пузыри, крестообразные водяные всплески, частицы, усиления и все элементы интерфейса процедурными. Для режима Three.js подготовьте соответствующие геометрические версии сцены и персонажей. Переключение визуальных режимов не должно менять состояние матча, позиции, таймер и счёт.

5. Игровой процесс и обратная связь
Используйте непрерывное перемещение с учётом delta time, нормализованной скоростью по диагонали, коллизиями и плавно следующей камерой. Клавиатура: WASD или стрелки — движение; F — установка пузыря; Space — прыжок; Q/E — поворот камеры; перетаскивание сцены — изменение направления и наклона камеры; Esc — пауза; Shift — рывок длительностью 0,3 секунды с перезарядкой 4 секунды. На сенсорных экранах добавьте левый виртуальный джойстик и отдельные кнопки пузыря и прыжка справа, которые должны работать одновременно.
Пузырь занимает ячейку на земле 2,5 секунды, после чего выпускает крестообразный водяной всплеск по четырём направлениям сетки. Сплошные клумбы и границы останавливают его. Первый поражённый ящик в каждом направлении ломается и останавливает соответствующую ветвь всплеска. Близлежащие пузыри вступают в цепную реакцию. Позвольте владельцу покинуть только что установленный пузырь, но не позволяйте пройти обратно сквозь него. Соблюдайте ограничение на количество активных пузырей и запрещайте их установку в воздухе.
Вода удерживает персонажа 3,5 секунды. Четыре отдельных нажатия Space освобождают персонажа; X расходует одну спасательную иглу за матч для немедленного освобождения. Персонаж противоположной команды, коснувшийся обездвиженного персонажа, немедленно захватывает его; в противном случае по истечении времени ловушки очко захвата получает команда противника, а жертва возрождается. Члены красной команды не захватывают и не повреждают друг друга. Самопопадание в ловушку также приносит команде противника очко, если время ловушки истекает. Прыжки на высоту и верхние поверхности платформ позволяют избежать низких водяных всплесков.
Начальные профили: у Blue — 2 пузыря, дальность 2 и скорость передвижения 4.25; у Mint — 1 пузырь, дальность 2 и скорость 5.15; у Mango — 1 пузырь, дальность 3 и скорость 4.55. Усиления пузыря, дальности и скорости улучшают соответствующие характеристики. Добавьте понятную обратную связь при подборе предметов и отзывчивые эффекты воды, движения, прыжка, обездвиживания и захвата. Добавьте короткие синтезированные звуковые эффекты с кнопкой отключения звука.
Побеждает команда, первой совершившая 3 захвата. Через 180 секунд сравните счёт команд; при равном счёте объявляется ничья. Добавьте лёгкий и обычный уровни сложности для противников, которые перемещаются, избегают опасностей, устанавливают пузыри и стремятся совершать захваты. Пауза замораживает симуляцию; повтор игры сбрасывает матч. Сохраняйте лучший результат локально.

6. Техническая реализация и мастерская персонажей
Используйте Three.js 0.180, модули JavaScript ES и Vite. Разделите симуляцию, рендеринг сцены, загрузку моделей, ввод и интерфейс, а также переводы. Включите зависимости времени выполнения, GLB-файлы, текстуры и уведомления в статические файлы из того же источника; для игры не должны требоваться аккаунт или сервер. Используйте GLTFLoader, клонирование через SkeletonUtils и AnimationMixer для моделей с ригом, а для повторяющихся ассетов окружения — пулы или переиспользуемые геометрию и материалы. В поставляемом проекте используются персонажи и ассеты окружения, созданные Tripo P2; сохраните сведения об их происхождении, а также работоспособность скелетов и встроенных анимаций.
Предоставьте интерфейс на китайском, английском и корейском языках. Сохранённый пользователем выбор языка всегда имеет приоритет. В противном случае используйте часовой пояс устройства по IANA: зоны материкового Китая, такие как Asia/Shanghai и Asia/Urumqi, выбирают китайский; Asia/Seoul и Asia/Pyongyang — корейский; Гонконг, Макао, Тайвань и все остальные или недоступные часовые пояса — английский. Последовательно обрабатывайте устаревшие псевдонимы. Не определяйте материковый Китай по смещению UTC или языку браузера. Не сохраняйте автоматический выбор как пользовательское предпочтение.
Мастерская принимает GLB со встроенными текстурами размером до 40 МБ и проверяет наличие фактического скиннинга, скелета, суставов и весов перед добавлением персонажа. Отклоняйте статические модели без рига с понятным объяснением. Разбирайте модель локально в браузере. Формируйте стабильный стартовый профиль на основе хеша содержимого файла, чтобы один и тот же файл всегда получал одинаковые сбалансированные характеристики. Добавьте настройку ориентации на 90 градусов.
Объясните, что риггинг и скиннинг обязательны, а отдельные клипы анимации необязательны для поддерживаемых стандартных гуманоидных скелетов: отдавайте предпочтение встроенным клипам покоя, бега, ходьбы и прыжка; при их отсутствии управляйте базовыми анимациями покоя и ходьбы через узнаваемые кости конечностей. Для нераспознанных или негуманоидных ригов необходимо наличие пригодных клипов анимации. Не обещайте автоматическую анимацию для произвольных скелетов. Объясните, какие сжатые форматы GLB не поддерживаются, и как экспортировать стандартный несжатый файл. После обновления страницы загруженных персонажей нужно выбрать заново.
Предложите понятное действие для создания персонажа, ведущее на https://studio.tripo3d.ai/?utm_source=satellite_invite&utm_medium=bubble-bay&utm_campaign=create-character . Объясните этапы создания, риггинга, экспорта и возврата в игру. Разместите эту справку в мастерской, не блокируя первый матч.

7. Приёмка и поставка
Предоставьте редактируемый исходный код, lockfile зависимостей, README, инструкции по локальному запуску, production-сборку для статики и доступный URL игры. Проверьте главный экран, активную битву, состояние обездвиживания, водяной всплеск, приземление на платформу, результаты, паузу и повтор игры. Подтвердите видимые различия между Tripo и Three.js без сброса игрового процесса. Проверьте реальный ввод с клавиатуры и эмуляцию сенсорного управления, включая одновременное движение и установку пузыря; честно обозначьте эмуляцию и не заявляйте о проверке на физических устройствах. Протестируйте импорт персонажа: отклонение модели без рига, анимированный риг и поддерживаемый риг без клипов. Проверьте часовые пояса материкового Китая, Гонконга, Макао, Тайваня, Кореи и других регионов, а также сохранение ручного выбора. Проверьте фактически размещённую страницу, ассеты из того же источника, ссылку на мастерскую и встроенное использование. Сохраните настоящую запись игрового процесса и показательные скриншоты, соответствующие поставленной версии двора; не заменяйте их прежней планировкой с удалённым островом. Сохраните указание авторства и исходников, а также уведомления о лицензиях сторонних компонентов, не распространяя ассеты референсного сайта.

```

[Подробнее ↗](https://www.tripo3d.ai/ru/3d-prompts/bubble-bay) · [Демо](https://bubble-bay.tripo.page/) · [Назад к примерам](#all-prompts)
...
<tr><td align="center">
<br>
<p><strong><a href="https://www.tripo3d.ai/ru/3d-prompts/models/gpt-6-astra?utm_source=github&amp;utm_medium=referral&amp;utm_campaign=awesome_astra_prompts&amp;utm_content=catalog_bottom">Все 264 примеров на официальном сайте →</a></strong></p>
