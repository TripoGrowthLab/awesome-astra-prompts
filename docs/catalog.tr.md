...
<a href="https://www.tripo3d.ai/tr/3d-prompts/bubble-bay"><img src="../assets/previews/3f9d3b8fcab4a54ff4bf19c6f25eb3f3ce6ce697cb929ab0abf86e89d6b8f708.jpg" width="840" loading="lazy" alt="Bubble Bay: 3B Su Balonu Savaşı"></a>

<a href="https://www.tripo3d.ai/tr/3d-prompts/bubble-bay"><img src="../assets/previews/a0927800e707bb993467cd9c9d32d7955cafcad0fe1ab3986c33d6bec6ce85f8.jpg" width="840" loading="lazy" alt="Bubble Bay: 3B Su Balonu Savaşı"></a>

<a href="https://www.tripo3d.ai/tr/3d-prompts/bubble-bay"><img src="../assets/previews/44f0d05c544d89c5044aece0e9da8cc3730bc51d81f395ff0e554bbceb4f2ab2.jpg" width="840" loading="lazy" alt="Bubble Bay: 3B Su Balonu Savaşı"></a>

Pirate14 ve Village10 haritalarında üç animasyonlu P2 karakteri, yakın perspektif, yanardöner tuzak baloncukları, yapılandırılabilir yakalama hedefleri, yapay zekâ rakipleri, özel karakter içe aktarma ve özgün ElevenLabs müziğiyle klasik bir 3B su balonu savaşı oluşturun. Varsayılan hedef altı yakalama olsun; karşılaştırma sekmelerini yalnızca yükleme tamamlandıktan sonra gösterin.

**İstem**

```text
Klasik BnB'yi hemen çağrıştıran, oynanabilir bir Three.js su balonu arenası olan Bubble Bay'i oluşturun. Varsayılan olarak ayrıntılı Tripo modellerini kullanın ve maçın korunmasını sağlayan, açıkça görünen bir Three.js geometri karşılaştırma anahtarı ekleyin. Boz/Bazzi, Ike/Uni ve Plunk/Keffy için sağlanan özgün karakter referanslarını kullanın; bunları yalnızca kabaca esinlenilmiş, metinle üretilmiş tasarımlarla değiştirmek yerine yüz özelliklerini, başlıklarını, renklerini, kıyafetlerini ve vücut oranlarını koruyun.

Karakter ve toplanabilir nesne geometrisini, açıkça tripo-p2 belirterek Tripo CLI ile üretin. Önden bakan nötr referans pozları hazırlayın, modelleri oluşturun, gerçek iki ayaklı iskeletleri geçerli skin ağırlıklarıyla bağlayın ve GLB olarak dışa aktarın. Görev kimliklerini, kredileri, özgün skin uygulanmış dosyaları ve nihai hash değerlerini koruyun. Bekleme/koşma/zıplama animasyonları gerçek eklemleri hareket ettirmelidir. Aşırı büyük baş, kulak ve eldivenlerin skin uygulamasını düzeltin; birden fazla görünümü ve hareketi inceleyin. Yerel olarak hazırlanmış klipleri doğru biçimde tanımlayın; bunları Tripo ön ayarları olarak göstermeyin. Özgün karakterlerin herkese açık kullanım hakları ayrıca doğrulanmalıdır; yapay zekâ ile üretim izin anlamına gelmez.

Yerelleştirilmiş adlar: 宝宝 / 배찌 / Boz (Bazzi), 小乖 / 우니 / Ike (Uni), 胖墩 / 케피 / Plunk (Keffy). Başlangıç kapasite/menzil/hız seviyeleri: 1/1/5, 1/2/5, 1/2/4; üst sınırlar: 6/7/9, 6/7/8, 9/8/8. Hızı, saniyede 0.25 + seviye*0.8 dünya birimi olacak şekilde dönüştürün; karolar 2 birimdir. Bir karakter seçildiğinde diğer ikisini eşleşen profillere sahip, birbirinden farklı rakipler olarak atayın.

Varsayılan olarak 15x13 Pirate/Patrit14 ve Village10 haritalarını sunun. Tanınabilir altın renkli güverteyi, sarı yükü, ahşap kasaları, dört topu ve merkezi direği koruyun; köyde dört renkli konut bölgesi, merkezi bir yol, çitler ve oyuncak bloklar bulunmalıdır. Yayıncı haritalarını referans olarak kullanın, çalışma zamanındaki görsel öğeleri kendiniz oluşturun ve kesintisiz 3B hareket ile yapay zekânın kaçışı için gereken küçük rota açıklıklarını belgeleyin. Parlak malzemeler, gölgeler, okyanus manzarası, net kamera takibi ve genel görünüm sağlayın.

Bir oyuncu, iş birliği yapan iki yapay zekâ rakibiyle karşılaşır. WASD/ok tuşları hareket eder, F 2,5 saniyelik bir baloncuk yerleştirir, Space gerçek platformların üzerine zıplar, Shift hız atılımı yapar, Q/E yörüngede döner, V görünümü değiştirir ve Escape oyunu duraklatır. Artı biçimli su engellere uyar, ilk yumuşak bloğu kırar ve baloncukları zincirler. Yakalama, kaçış, düşmanların yakalanması, yeniden doğma, 3, 6, 9 veya 12 yakalamadan seçilebilir hedef (varsayılan 6) ya da 180 saniyelik puan modu, sonuç ve yeniden deneme özelliklerini uygulayın. Dokunmatik joystick ile eylem düğmeleri aynı anda çalışmalıdır.

Üretilen altı Tripo toplanabilir nesnesini kullanın: balon, menzil iksiri, tekerlekli paten, fırlatma eldiveni, tekme botu ve kurtarma iğnesi. Kasalar zamanın %85'inde bir eşya düşürür. Koşullu eşya ağırlıkları: %30/%30/%30/%2,5/%3,5/%4. Eldivenler üç ek atış sağlar; üst sınır altı atıştır. G, yakındaki bir baloncuğu örtünün üzerinden en fazla dört karo uzağa fırlatır; baloncuğun sahibini ve özgün fitil süresini korur, iniş konumunu ayırır ve bir yay gösterir. Uçuş sırasında süresi dolan baloncuk iner ve patlar. K, baloncukları engellenene kadar kaydırır ve fitil süresini sıfırlamaz. X, başlangıçta bir ve üst sınırı üç olan kurtarma iğnesini kullanır. Envanteri ve kullanılabilir kontrolleri açıkça gösterin.

Çince, İngilizce ve Korece kullanıcı arayüzü: Çin ana karasına ait IANA saat dilimleri Çinceyi, Güney Kore/Kuzey Kore Koreceyi, Hong Kong/Makao/Tayvan dâhil diğer tüm bölgeler İngilizceyi seçer. Manuel seçim her zaman önceliklidir. Yalnızca gömülü dokulu, standart sıkıştırılmamış ve gerçekten skin uygulanmış, en fazla 40 MB ve 150 bin üçgen içeren GLB dosyalarını yükleyin. Kemikleri, eklemleri ve ağırlıkları doğrulayın; statik modelleri reddedin; varsa gömülü animasyonları kullanın ve klip içermeyen, tanınan humanoid modeller için temel eklem hareketi sağlayın. Tanınmayan iskeletlerde animasyon bulunmalıdır. Rigging ile animasyon arasındaki farkı açıkça anlatın, 90 derecelik yön ayarı sağlayın, işlemleri tarayıcı içinde yerel olarak gerçekleştirin ve dosya hash'ine göre kararlı, dengeli istatistikler atayın.

Oluşturma CTA'sı için tam olarak https://studio.tripo3d.ai/?utm_source=satellite_invite&utm_medium=bubble-bay&utm_campaign=create-character kullanın. jared'e https://x.com/jaredliu_bravo bağlantısını vererek kredi ekleyin.

13 ElevenLabs ses efektini normalleştirme, kısa sönümlenme, mesafe/pan, polifoni sınırları, ses düzeyi ve sessize alma özellikleriyle entegre edin: yerleştirme, patlama, kasa, toplanabilir nesne, nadir eşya, fırlatma, iniş, yakalanma, kurtarma, zıplama, zafer, yenilgi ve tekme. ElevenLabs music_v2_5 ile her biri 90 saniye uzunluğunda, denizci korsan haritasına ve güneşli mahalleye uygun iki özgün enstrümantal parça oluşturun. Bunları ölçülü -20 LUFS hedefinde normalleştirin ve döngü sınırlarında çapraz geçiş uygulayın. Müziğin kendi ses düzeyi kontrolü olsun; parçaları haritaya göre değiştirin, duraklatıldığında sesi kademeli olarak azaltın ve ana sessize alma ayarına uyun. Özgün oyun müziğini yeniden üretmeyin.

Bağımsız kaynak kodunu, bağımlılıkları, testleri ve varlık köken bilgilerini CMS platform uygulamalarının dışında tutun. Aynı kaynak üzerinden sunulan statik kaynakları ve MIT bildirimlerini paketleyin. Gerçek masaüstü ve dokunmatik oynanışı, yükleme varyantlarını, dilleri ve görsel geçişleri Ego Lite'ta doğrulayın. Mevcut CMS Web Page12'ye bağlı, değiştirilemez bir inceleme sürümü oluşturun; inceleme tamamlanana kadar mevcut canlı sürümü koruyun. Yalnızca kaynak kodu ve varlık hakları temizliği gerçeğe uygun biçimde doğrulandıktan sonra yayımlayın; ardından herkese açık URL'yi, model hash'lerini ve davranışı doğrulayın. Geçmişi koruyun ve kaydedilmiş CMS kayıtlarıyla önizlemeleri ve herkese açık sürümleri birbirinden ayırın.

Model varlıklarını görünür ilerleme göstergesiyle, aynı anda en fazla üç indirme, 30 saniyelik boşta kalma zaman aşımı ve iki denemeyle yükleyin. Yeniden denemede başarılı indirmeleri koruyun. Tüm modeller hazır olana kadar Tripo / Three.js sekme anahtarının tamamını gizleyin, ardından gösterin. Prosedürel yükleme yer tutucularını yüklenmiş Tripo modelleri olarak etiketlemeyin.


Doğma alanının dışında başlayıp arenanın merkezine bakan, yakın perspektifli bir takip kamerası kullanın. Q/E yörüngesini, fareyle sürükleyerek eğimi ve V genel görünümünü koruyun. Üstte kompakt bir skor tablosu, sol üstte mod anahtarını ve altta kısa bildirimleri tutun. Fare kullanılan masaüstü bilgisayarlarda joystick'i ve büyük dokunmatik eylem düğmelerini gizleyin; küçük nadir eşya kontrollerini koruyun. Dar ekranlarda kompakt ve eş zamanlı dokunmatik eylemleri destekleyin. Turkuaz derinlik değişimine sahip animasyonlu bir dalga shader'ı, kıvrımlı palmiyeler ve kayalar içeren organik kum adacıkları, ince ahşap damarları ve çim dokuları ekleyin. Yakalanan her karakteri, boyutuna uygun yarı saydam bir baloncukla çevreleyin; baloncukta yanardöner bir Fresnel kenarı, yumuşak süzülme, küçük baloncuklar ve zeminde dalgalanmalar bulunsun. Poz verilmiş skin köşelerinin oturduğunu doğrulayın, kurtarma sonrasında yükselme değerini sıfırlayın ve tekrarlı geçişlerden sonra kaynakların serbest bırakıldığını kontrol edin. Su zarında pahalı, sahne geneline uygulanan transmission geçişlerinden kaçının; dar ekranlarda piksel oranını 1,5 ile sınırlayın.
