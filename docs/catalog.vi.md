...
<a href="https://www.tripo3d.ai/vi/3d-prompts/bubble-bay"><img src="../assets/previews/3f9d3b8fcab4a54ff4bf19c6f25eb3f3ce6ce697cb929ab0abf86e89d6b8f708.jpg" width="840" loading="lazy" alt="Bubble Bay: Đại chiến bóng nước 3D"></a>

<a href="https://www.tripo3d.ai/vi/3d-prompts/bubble-bay"><img src="../assets/previews/a0927800e707bb993467cd9c9d32d7955cafcad0fe1ab3986c33d6bec6ce85f8.jpg" width="840" loading="lazy" alt="Bubble Bay: Đại chiến bóng nước 3D"></a>

<a href="https://www.tripo3d.ai/vi/3d-prompts/bubble-bay"><img src="../assets/previews/44f0d05c544d89c5044aece0e9da8cc3730bc51d81f395ff0e554bbceb4f2ab2.jpg" width="840" loading="lazy" alt="Bubble Bay: Đại chiến bóng nước 3D"></a>

Xây dựng một trận chiến bóng nước 3D kinh điển trên Pirate14 và Village10 với ba nhân vật P2 hoạt hình, góc nhìn cận cảnh, bong bóng bẫy óng ánh, mục tiêu bắt có thể tùy chỉnh, đối thủ AI, tính năng nhập nhân vật tùy chỉnh và nhạc gốc từ ElevenLabs. Mặc định sáu lần bắt; chỉ hiển thị các tab so sánh sau khi tải xong.

**Prompt**

```text
Xây dựng Bubble Bay, một đấu trường bóng nước Three.js có thể chơi ngay, gợi nhớ rõ nét đến BnB kinh điển. Mặc định sử dụng các mô hình Tripo chi tiết, kèm nút chuyển đổi so sánh hình học Three.js dễ nhận biết nhưng không làm gián đoạn trận đấu. Dùng các ảnh tham chiếu nhân vật gốc được cung cấp cho Boz/Bazzi, Ike/Uni và Plunk/Keffy; giữ nguyên đặc điểm khuôn mặt, mũ nón, màu sắc, trang phục và tỷ lệ cơ thể thay vì thay thế bằng các thiết kế tạo từ văn bản chỉ lấy cảm hứng chung.

Tạo hình học nhân vật và vật phẩm nhặt được bằng Tripo CLI với tham số tripo-p2 được chỉ định rõ ràng. Chuẩn bị tư thế tham chiếu trung tính, hướng thẳng mặt, tạo mô hình, gắn skeleton người hai chân thực với trọng số skin hợp lệ và xuất GLB. Giữ nguyên ID tác vụ, credit, các tệp đã skin ban đầu và hash cuối cùng. Hoạt ảnh đứng yên/chạy/nhảy phải chuyển động các khớp thực tế. Sửa lỗi skin ở phần đầu/tai/găng tay quá khổ, đồng thời kiểm tra nhiều góc nhìn và chuyển động. Các clip do nhóm tự tạo phải được mô tả chính xác, không gọi là preset Tripo. Quyền sử dụng công khai đối với nhân vật gốc cần được xác nhận riêng; việc tạo bằng AI không đồng nghĩa với việc được cấp phép.

Tên bản địa hóa: 宝宝 / 배찌 / Boz (Bazzi), 小乖 / 우니 / Ike (Uni), 胖墩 / 케피 / Plunk (Keffy). Mức sức chứa/tầm hoạt động/tốc độ ban đầu: 1/1/5, 1/2/5, 1/2/4; giới hạn: 6/7/9, 6/7/8, 9/8/8. Quy đổi tốc độ thành 0.25 + cấp độ*0.8 đơn vị thế giới mỗi giây; mỗi ô rộng 2 đơn vị. Khi chọn một nhân vật, gán hai nhân vật còn lại làm các đối thủ riêng biệt với hồ sơ tương ứng.

Mặc định cung cấp Pirate/Patrit14 kích thước 15x13 và Village10. Giữ các đặc điểm dễ nhận biết gồm boong tàu màu vàng kim, hàng hóa màu vàng, thùng gỗ, bốn khẩu pháo và cột buồm trung tâm; ngôi làng có bốn khu nhà mang màu sắc khác nhau, một con đường trung tâm, hàng rào cây và các khối đồ chơi. Dùng bản đồ của nhà phát hành làm tài liệu tham chiếu, tự xây dựng hình ảnh khi chạy, đồng thời ghi lại các lối mở nhỏ cần thiết cho chuyển động 3D liên tục và việc AI tìm đường thoát. Cung cấp vật liệu sáng màu, bóng đổ, cảnh đại dương, camera bám theo rõ ràng và góc nhìn tổng quan.

Một người chơi đối đầu với hai đối thủ AI phối hợp. WASD/phím mũi tên để di chuyển, F đặt bong bóng tồn tại 2.5 giây, Space nhảy lên các nền tảng thực, Shift lướt nhanh, Q/E xoay quanh, V đổi góc nhìn và Escape tạm dừng. Nước hình chữ thập phải tuân theo vật cản, phá khối mềm đầu tiên và tạo chuỗi bong bóng. Triển khai cơ chế giam giữ, trốn thoát, bắt kẻ địch, hồi sinh, mục tiêu có thể chọn gồm 3, 6, 9 hoặc 12 lần bắt (mặc định 6), hoặc chế độ tính điểm trong 180 giây, kèm kết quả và chơi lại. Cần hỗ trợ đồng thời cần điều khiển cảm ứng và các nút hành động.

Sử dụng sáu vật phẩm nhặt được do Tripo tạo: bóng bay, thuốc tăng tầm, giày patin, găng tay ném, ủng đá và kim cứu hộ. Thùng rơi vật phẩm với xác suất 85%. Trọng số vật phẩm theo điều kiện: 30/30/30/2.5/3.5/4 phần trăm. Găng tay cộng thêm ba lần ném, tối đa sáu lần. G ném một bong bóng gần đó đi tối đa bốn ô qua vật che chắn, giữ nguyên chủ sở hữu và thời gian cháy ban đầu, đồng thời đặt trước vị trí hạ cánh và hiển thị quỹ đạo. Bong bóng hết thời gian khi đang bay sẽ hạ xuống và phát nổ. K đẩy bong bóng trượt đi cho đến khi bị chặn mà không đặt lại thời gian cháy. X dùng kim cứu hộ, bắt đầu ở mức một và tối đa ba. Hiển thị rõ kho đồ và các điều khiển khả dụng.

Giao diện tiếng Trung, tiếng Anh và tiếng Hàn: múi giờ IANA của Trung Quốc đại lục chọn tiếng Trung, Hàn Quốc/Bắc Triều Tiên chọn tiếng Hàn, tất cả khu vực khác gồm Hồng Kông/Ma Cao/Đài Loan chọn tiếng Anh. Lựa chọn thủ công luôn được ưu tiên. Chỉ tải lên GLB có kết cấu bề mặt nhúng, định dạng chuẩn không nén, thực sự có skin, tối đa 40 MB và 150k tam giác. Kiểm tra xương, khớp và trọng số, từ chối mô hình tĩnh, sử dụng hoạt ảnh nhúng nếu có, đồng thời cung cấp chuyển động khớp cơ bản cho humanoid được nhận diện khi không có clip. Skeleton không được nhận diện phải có hoạt ảnh. Giải thích rõ ràng sự khác nhau giữa rigging và hoạt ảnh, cung cấp điều chỉnh hướng 90 độ, xử lý cục bộ ngay trong trình duyệt và gán chỉ số ổn định, cân bằng dựa trên hash tệp.

Sử dụng chính xác https://studio.tripo3d.ai/?utm_source=satellite_invite&utm_medium=bubble-bay&utm_campaign=create-character cho CTA tạo mới. Ghi credit cho jared bằng cách liên kết đến https://x.com/jaredliu_bravo .

Tích hợp 13 hiệu ứng âm thanh ElevenLabs với chuẩn hóa âm lượng, độ tắt dần ngắn, khoảng cách/pan, giới hạn số âm thanh đồng thời, âm lượng và tắt tiếng: đặt, nổ, thùng, nhặt vật phẩm, hiếm, ném, hạ cánh, bẫy, cứu hộ, nhảy, thắng, thua, đá. Tạo hai bản nhạc không lời nguyên bản bằng ElevenLabs music_v2_5, mỗi bản dài 90 giây, phù hợp với bản đồ cướp biển hàng hải và khu phố đầy nắng. Chuẩn hóa về mức mục tiêu tiết chế -20 LUFS và crossfade tại điểm lặp. Cho nhạc một nút chỉnh âm lượng riêng, đổi bản nhạc theo bản đồ, fade khi tạm dừng và tuân theo chế độ tắt tiếng tổng. Không sao chép nhạc nền gốc của trò chơi.

Giữ mã nguồn, dependency, bài kiểm thử và nguồn gốc tài sản độc lập, bên ngoài các ứng dụng nền tảng CMS. Đóng gói tài nguyên tĩnh cùng origin và thông báo MIT. Kiểm tra gameplay thực tế trên máy tính và thiết bị cảm ứng, các biến thể tải lên, ngôn ngữ và chuyển đổi hình ảnh trong Ego Lite. Tạo một phiên bản đánh giá bất biến gắn với Web Page12 hiện có của CMS; giữ nguyên bản phát hành đang hoạt động trong khi chờ đánh giá. Chỉ xuất bản sau khi đã xác minh trung thực nguồn và quyền tài sản, rồi kiểm tra URL công khai, hash mô hình và hành vi. Giữ lịch sử, phân biệt rõ bản ghi CMS đã lưu, bản xem trước và bản phát hành công khai.

Tải tài sản mô hình với thanh tiến trình hiển thị, tối đa ba lượt tải đồng thời, thời gian chờ không hoạt động 30 giây và hai lần thử. Giữ lại các lượt tải thành công khi thử lại. Ẩn toàn bộ nút chuyển đổi tab Tripo / Three.js cho đến khi tất cả mô hình sẵn sàng, sau đó mới hiển thị. Không gắn nhãn các placeholder tải theo thủ tục là mô hình Tripo đã tải xong.


Dùng camera bám theo góc nhìn cận cảnh, bắt đầu bên ngoài khu vực xuất hiện và hướng về tâm đấu trường. Giữ thao tác xoay Q/E, kéo chuột để nghiêng và chế độ tổng quan V. Đặt bảng điểm gọn ở phía trên, nút chuyển chế độ ở góc trên bên trái và thông báo ngắn gần phía dưới. Ẩn cần điều khiển và các nút cảm ứng lớn trên máy tính dùng chuột, nhưng giữ các nút điều khiển vật phẩm hiếm nhỏ; hỗ trợ đồng thời các thao tác cảm ứng gọn trên màn hình hẹp. Thêm shader sóng hoạt ảnh với biến thiên độ sâu màu xanh ngọc, các đảo cát hữu cơ với cây cọ và đá cong, cùng kết cấu vân gỗ và cỏ tinh tế. Bao quanh mỗi nhân vật bị bắt trong một bong bóng bán trong suốt vừa với kích thước, có viền Fresnel óng ánh, chuyển động nổi nhẹ, bong bóng nhỏ và gợn sóng trên mặt đất. Kiểm tra các đỉnh đã skin trong tư thế có vừa khít, đặt lại độ nâng khi cứu hộ và kiểm tra giải phóng tài nguyên sau nhiều lần chuyển đổi. Tránh các pass truyền sáng tốn kém trên toàn cảnh cho màng nước; giới hạn pixel ratio ở màn hình hẹp xuống 1.5.
