...
[← Awesome Astra Prompts](../README.md)

These repositories are linked to the source posts in the collection. Four examples share three repositories. Check the code, dependencies and license before using a project. A public repository is not automatically open source.

License snapshot checked on September 6, 2026: `petergpt/gogh-strike` and `emollick/abyssal-living-deep` declare MIT; `alesha-pro/bench-portal` has no detected license. Recheck the current repository before reuse.
